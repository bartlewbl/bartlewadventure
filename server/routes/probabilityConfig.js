...
const DEFAULTS = [
  ...
  { key: 'combat.monsterCritBase', value: 0.03, category: 'Combat', label: 'Monster Crit Base', description: 'Base monster crit chance (3%)' },
  { key: 'combat.monsterCritPerLevel', value: 0.0005, category: 'Combat', label: 'Monster Crit Per Level', description: 'Crit chance added per monster level' },
  { key: 'combat.monsterCritCap', value: 0.08, category: 'Combat', label: 'Monster Crit Cap', description: 'Maximum monster crit chance (8%)' },
  { key: 'combat.monsterCritMultiplier', value: 1.5, category: 'Combat', label: 'Monster Crit Multiplier', description: 'Monster crit damage multiplier' },
  { key: 'combat.monsterSkillChance', value: 0.3, category: 'Combat', label: 'Monster Skill Chance', description: 'Chance monster uses a skill instead of basic attack (30%)' },
  ...
  // --- Scaling ---
  { key: 'scaling.monsterHpMult', value: 1.25, category: 'Scaling', label: 'Monster HP Multiplier', description: 'HP multiplier for all monsters (1.25 = +25%)' },
  { key: 'scaling.monsterAtkMult', value: 1.15, category: 'Scaling', label: 'Monster ATK Multiplier', description: 'ATK multiplier for all monsters (1.15 = +15%)' },
  { key: 'scaling.monsterDefMult', value: 1.15, category: 'Scaling', label: 'Monster DEF Multiplier', description: 'DEF multiplier for all monsters (1.15 = +15%)' },
  { key: 'scaling.monsterLevelScale', value: 0.2, category: 'Scaling', label: 'Monster Level Scale', description: 'Per-level scaling for monsters (20% per level)' },
  { key: 'scaling.bossLevelScale', value: 0.25, category: 'Scaling', label: 'Boss Level Scale', description: 'Per-level scaling for bosses (25% per level)' },
