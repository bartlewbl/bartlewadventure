  ...
  berserker: {
    tiers: [
      ...
      { level: 52, label: 'Tier 26', choices: [
        ...
        { id: 'brs_t26b', name: 'Hemorrhaging Slash', type: 'active', desc: '6.0x damage, apply bleed for 5 turns (4% max HP/turn)', manaCost: 28, multiplier: 6.0, effect: 'hemorrhage_5', icon: 'A' },
      ...
      { level: 54, label: 'Tier 27', choices: [
        ...
        { id: 'brs_t27b', name: 'Cataclysmic Fury', type: 'active', desc: '7.0x damage, +50% if below 50% HP', manaCost: 30, multiplier: 7.0, effect: 'cata_fury', icon: 'A' },
      ...
      { level: 56, label: 'Tier 28', choices: [
        ...
        { id: 'brs_t28b', name: 'Titan Rend', type: 'active', desc: '8.0x damage, ignore 70% DEF, 10% recoil', manaCost: 34, multiplier: 8.0, effect: 'titan_rend', icon: 'A' },
      ...
      { level: 58, label: 'Tier 29', choices: [
        ...
        { id: 'brs_t29b', name: 'Oblivion Cleave', type: 'active', desc: '5.0x damage twice, ignore 40% DEF each hit', manaCost: 32, multiplier: 5.0, effect: 'double_pierce_40', icon: 'A' },
      ...
      { level: 60, label: '★ Tier 30', milestone: true, choices: [
        ...
        { id: 'brs_t30b', name: 'Armageddon Strike', type: 'active', desc: '15.0x damage. Costs 40% current HP. If enemy dies, restore all HP. If not, stunned 2 turns.', manaCost: 45, multiplier: 15.0, effect: 'armageddon_strike', icon: 'A', milestone: true },
      ...
      { level: 62, label: 'Tier 31', choices: [
        ...
        { id: 'brs_t31b', name: 'Savage Onslaught', type: 'active', desc: '4.5x damage 3 times', manaCost: 34, multiplier: 4.5, effect: 'triple_strike_45', icon: 'A' },
      ...
      { level: 64, label: 'Tier 32', choices: [
        ...
        { id: 'brs_t32b', name: 'World Render', type: 'active', desc: '9.0x damage, shred enemy DEF to 0, 15% recoil', manaCost: 36, multiplier: 9.0, effect: 'world_render', icon: 'A' },
      ...
      { level: 66, label: 'Tier 33', choices: [
        ...
        { id: 'brs_t33b', name: 'Infernal Blow', type: 'active', desc: '7.5x damage, enemy ATK & DEF -40%', manaCost: 32, multiplier: 7.5, effect: 'infernal_blow', icon: 'A' },
      ...
      { level: 68, label: 'Tier 34', choices: [
        ...
        { id: 'brs_t34b', name: 'Decimating Fury', type: 'active', desc: '6.0x damage twice, each hit ignores 50% DEF', manaCost: 36, multiplier: 6.0, effect: 'double_pierce_50', icon: 'A' },
      ...
      { level: 70, label: '★ Tier 35', milestone: true, choices: [
        ...
        { id: 'brs_t35b', name: 'Extinction Blow', type: 'active', desc: '25.0x damage. Costs 60% current HP. If enemy survives, your ATK is halved permanently. All or nothing.', manaCost: 55, multiplier: 25.0, effect: 'extinction_blow', icon: 'A', milestone: true },
      ...
      { level: 72, label: 'Tier 36', choices: [
        ...
        { id: 'brs_t36b', name: 'Cataclysm Wave', type: 'active', desc: '8.5x damage, enemy DEF & ATK -50%', manaCost: 38, multiplier: 8.5, effect: 'cata_wave', icon: 'A' },
      ...
      { level: 74, label: 'Tier 37', choices: [
        ...
        { id: 'brs_t37b', name: 'Annihilation Slam', type: 'active', desc: '10.0x damage, 20% recoil, ignore all DEF', manaCost: 40, multiplier: 10.0, effect: 'annihilation_slam', icon: 'A' },
      ...
      { level: 76, label: 'Tier 38', choices: [
        ...
        { id: 'brs_t38b', name: 'Doomsday Cleave', type: 'active', desc: '7.0x damage 2 times, bleed 5 turns each', manaCost: 38, multiplier: 7.0, effect: 'doom_cleave', icon: 'A' },
      ...
      { level: 78, label: 'Tier 39', choices: [
        ...
        { id: 'brs_t39b', name: 'Primordial Rage', type: 'active', desc: '12.0x damage, heal 30% of damage dealt, ignore 60% DEF', manaCost: 42, multiplier: 12.0, effect: 'primordial_rage', icon: 'A' },
      ...
      { level: 80, label: '★ Tier 40', milestone: true, choices: [
        ...
        { id: 'brs_t40b', name: 'Ragnarök Reborn', type: 'active', desc: '30.0x damage. Costs 70% current HP and all mana. If enemy dies, fully heal and restore all mana. If not, ATK halved rest of fight.', manaCost: 60, multiplier: 30.0, effect: 'ragnarok_reborn', icon: 'A', milestone: true },
      ...
      { level: 82, label: 'Tier 41', choices: [
        ...
        { id: 'brs_t41b', name: 'Godslayer Strike', type: 'active', desc: '10.0x damage, ignore all DEF, enemy ATK -30%', manaCost: 40, multiplier: 10.0, effect: 'godslayer_strike', icon: 'A' },
      ...
      { level: 84, label: 'Tier 42', choices: [
        ...
        { id: 'brs_t42b', name: 'Apocalyptic Rampage', type: 'active', desc: '6.0x damage 3 times, 10% recoil', manaCost: 42, multiplier: 6.0, effect: 'apoc_rampage', icon: 'A' },
      ...
      { level: 86, label: 'Tier 43', choices: [
        ...
        { id: 'brs_t43b', name: 'World Ender', type: 'active', desc: '14.0x damage, shred enemy DEF to 0, 15% recoil', manaCost: 44, multiplier: 14.0, effect: 'world_ender', icon: 'A' },
      ...
      { level: 88, label: 'Tier 44', choices: [
        ...
        { id: 'brs_t44b', name: 'Cataclysmic Rend', type: 'active', desc: '8.0x damage twice, ignore 70% DEF each', manaCost: 44, multiplier: 8.0, effect: 'double_pierce_70', icon: 'A' },
      ...
      { level: 90, label: '★ Tier 45', milestone: true, choices: [
        ...
        { id: 'brs_t45b', name: 'Extinction Event', type: 'active', desc: '40.0x damage. Costs 80% current HP. Sets mana to 0. If enemy survives, fight continues but you cannot use skills for 3 turns.', manaCost: 70, multiplier: 40.0, effect: 'extinction_event_brs', icon: 'A', milestone: true },
      ...
      { level: 92, label: 'Tier 46', choices: [
        ...
        { id: 'brs_t46b', name: 'Divine Rampage', type: 'active', desc: '10.0x damage 2 times, heal 20% of total damage', manaCost: 44, multiplier: 10.0, effect: 'divine_rampage', icon: 'A' },
      ...
      { level: 94, label: 'Tier 47', choices: [
        ...
        { id: 'brs_t47b', name: 'Apocalypse Incarnate', type: 'active', desc: '16.0x damage, enemy ATK & DEF -60%, 20% recoil', manaCost: 48, multiplier: 16.0, effect: 'apoc_incarnate', icon: 'A' },
      ...
      { level: 96, label: 'Tier 48', choices: [
        ...
        { id: 'brs_t48b', name: 'Oblivion Rampage', type: 'active', desc: '8.0x true damage 3 times', manaCost: 50, multiplier: 8.0, effect: 'oblivion_rampage', icon: 'A' },
      ...
      { level: 98, label: 'Tier 49', choices: [
        ...
        { id: 'brs_t49b', name: 'End of All Things', type: 'active', desc: '20.0x damage, ignore all DEF, heal 50% of damage dealt', manaCost: 52, multiplier: 20.0, effect: 'end_all_things', icon: 'A' },
      ...
      { level: 100, label: '★ Tier 50', milestone: true, choices: [
        ...
        { id: 'brs_t50b', name: 'Final Ragnarök', type: 'active', desc: '50.0x damage. Costs all HP except 1 and all mana. If enemy dies, fully restore everything. If not, you die. The ultimate gamble.', manaCost: 1, multiplier: 50.0, effect: 'final_ragnarok', icon: 'A', milestone: true },
  ...
  warrior: {
    tiers: [
      ...
      { level: 52, label: 'Tier 26', choices: [
        ...
        { id: 'war_t26b', name: 'Divine Strike', type: 'active', desc: '6.0x damage, gain +25% DEF for rest of fight', manaCost: 28, multiplier: 6.0, effect: 'divine_strike', icon: 'A' },
      ...
      { level: 54, label: 'Tier 27', choices: [
        ...
        { id: 'war_t27b', name: 'Hammer of Justice', type: 'active', desc: '7.0x damage, stun enemy 2 turns', manaCost: 30, multiplier: 7.0, effect: 'hammer_justice', icon: 'A' },
      ...
      { level: 56, label: 'Tier 28', choices: [
        ...
        { id: 'war_t28b', name: 'Titanic Crush', type: 'active', desc: '8.0x damage, DEF added to ATK for this hit, stun 1 turn', manaCost: 32, multiplier: 8.0, effect: 'titanic_crush', icon: 'A' },
      ...
      { level: 58, label: 'Tier 29', choices: [
        ...
        { id: 'war_t29b', name: 'Champions Blow', type: 'active', desc: '5.5x damage twice, heal 15% max HP', manaCost: 32, multiplier: 5.5, effect: 'champions_blow', icon: 'A' },
      ...
      { level: 60, label: '★ Tier 30', milestone: true, choices: [
        ...
        { id: 'war_t30b', name: 'Judgment of Ages', type: 'active', desc: '15.0x damage. DEF added to ATK. Shatters your DEF to 0 for 3 turns. If enemy dies, DEF fully restored and doubled.', manaCost: 45, multiplier: 15.0, effect: 'judgment_ages', icon: 'A', milestone: true },
      ...
      { level: 62, label: 'Tier 31', choices: [
        ...
        { id: 'war_t31b', name: 'Seismic Wave', type: 'active', desc: '6.5x damage, enemy ATK & DEF -40%', manaCost: 30, multiplier: 6.5, effect: 'seismic_wave', icon: 'A' },
      ...
      { level: 64, label: 'Tier 32', choices: [
        ...
        { id: 'war_t32b', name: 'Executioners Judgment', type: 'active', desc: '9.0x damage, 12.0x if enemy below 30% HP', manaCost: 34, multiplier: 9.0, effect: 'exec_judgment', icon: 'A' },
      ...
      { level: 66, label: 'Tier 33', choices: [
        ...
        { id: 'war_t33b', name: 'Avalanche', type: 'active', desc: '5.0x damage 3 times, enemy DEF -20% each hit', manaCost: 36, multiplier: 5.0, effect: 'avalanche', icon: 'A' },
      ...
      { level: 68, label: 'Tier 34', choices: [
        ...
        { id: 'war_t34b', name: 'Cataclysmic Judgment', type: 'active', desc: '10.0x damage, DEF added to ATK, ignore 50% enemy DEF', manaCost: 38, multiplier: 10.0, effect: 'cata_judgment', icon: 'A' },
      ...
      { level: 70, label: '★ Tier 35', milestone: true, choices: [
        ...
        { id: 'war_t35b', name: 'World Sunder', type: 'active', desc: '25.0x damage. Consumes all DEF permanently. If enemy dies, DEF is tripled from base. The ultimate sacrifice strike.', manaCost: 55, multiplier: 25.0, effect: 'world_sunder', icon: 'A', milestone: true },
      ...
      { level: 72, label: 'Tier 36', choices: [
        ...
        { id: 'war_t36b', name: 'Holy Retribution', type: 'active', desc: '8.0x damage, heal 30% max HP, +20% DEF for 3 turns', manaCost: 36, multiplier: 8.0, effect: 'holy_retribution', icon: 'A' },
      ...
      { level: 74, label: 'Tier 37', choices: [
        ...
        { id: 'war_t37b', name: 'Judgment Storm', type: 'active', desc: '6.0x damage 3 times', manaCost: 40, multiplier: 6.0, effect: 'judgment_storm', icon: 'A' },
      ...
      { level: 76, label: 'Tier 38', choices: [
        ...
        { id: 'war_t38b', name: 'Worldbreaker Slam', type: 'active', desc: '12.0x damage, shred enemy DEF to 0, stun 1 turn', manaCost: 42, multiplier: 12.0, effect: 'worldbreaker_slam', icon: 'A' },
      ...
      { level: 78, label: 'Tier 39', choices: [
        ...
        { id: 'war_t39b', name: 'Heaven Splitter', type: 'active', desc: '10.0x damage, heal 25% damage dealt, ignore 60% DEF', manaCost: 40, multiplier: 10.0, effect: 'heaven_splitter', icon: 'A' },
      ...
      { level: 80, label: '★ Tier 40', milestone: true, choices: [
        ...
        { id: 'war_t40b', name: 'Final Crusade', type: 'active', desc: '30.0x damage. DEF doubled and added to ATK. After use, DEF becomes 0 permanently. One legendary strike.', manaCost: 60, multiplier: 30.0, effect: 'final_crusade', icon: 'A', milestone: true },
      ...
      { level: 82, label: 'Tier 41', choices: [
        ...
        { id: 'war_t41b', name: 'Decimation Strike', type: 'active', desc: '8.0x damage twice, +30% DEF for rest of fight', manaCost: 40, multiplier: 8.0, effect: 'decimation_strike', icon: 'A' },
      ...
      { level: 84, label: 'Tier 42', choices: [
        ...
        { id: 'war_t42b', name: 'Divine Retribution', type: 'active', desc: '10.0x damage, 15.0x if you defended last turn', manaCost: 38, multiplier: 10.0, effect: 'divine_retribution', icon: 'A' },
      ...
      { level: 86, label: 'Tier 43', choices: [
        ...
        { id: 'war_t43b', name: 'Apocalyptic Judgment', type: 'active', desc: '14.0x damage, enemy ATK & DEF -50%, heal 20% max HP', manaCost: 44, multiplier: 14.0, effect: 'apoc_judgment', icon: 'A' },
      ...
      { level: 88, label: 'Tier 44', choices: [
        ...
        { id: 'war_t44b', name: 'Titans Judgment', type: 'active', desc: '12.0x damage, stun 2 turns, heal 30% of damage dealt', manaCost: 46, multiplier: 12.0, effect: 'titans_judgment', icon: 'A' },
      ...
      { level: 90, label: '★ Tier 45', milestone: true, choices: [
        ...
        { id: 'war_t45b', name: 'Cataclysm of the Gods', type: 'active', desc: '40.0x damage. Consumes all DEF and 50% HP. If enemy dies, all stats tripled for rest of run. If not, DEF stays at 0.', manaCost: 70, multiplier: 40.0, effect: 'cata_gods', icon: 'A', milestone: true },
      ...
      { level: 92, label: 'Tier 46', choices: [
        ...
        { id: 'war_t46b', name: 'Divine Annihilation', type: 'active', desc: '14.0x damage, +20.0x if defended last turn', manaCost: 46, multiplier: 14.0, effect: 'divine_annihilation', icon: 'A' },
      ...
      { level: 94, label: 'Tier 47', choices: [
        ...
        { id: 'war_t47b', name: 'Worldshatter', type: 'active', desc: '10.0x damage 2 times, ignore all DEF', manaCost: 48, multiplier: 10.0, effect: 'worldshatter', icon: 'A' },
      ...
      { level: 96, label: 'Tier 48', choices: [
        ...
        { id: 'war_t48b', name: 'Judgment Absolute', type: 'active', desc: '16.0x damage, heal 40% of damage dealt, enemy ATK & DEF -60%', manaCost: 50, multiplier: 16.0, effect: 'judgment_absolute', icon: 'A' },
      ...
      { level: 98, label: 'Tier 49', choices: [
        ...
        { id: 'war_t49b', name: 'Divine Cataclysm', type: 'active', desc: '20.0x damage, DEF tripled and added to ATK for this hit', manaCost: 52, multiplier: 20.0, effect: 'divine_cataclysm', icon: 'A' },
      ...
      { level: 100, label: '★ Tier 50', milestone: true, choices: [
        ...
        { id: 'war_t50b', name: 'Final Judgment Absolute', type: 'active', desc: '50.0x damage. DEF quintupled and added to ATK. Permanently destroys all DEF after. The ultimate sacrifice for the ultimate strike.', manaCost: 1, multiplier: 50.0, effect: 'final_judgment_absolute', icon: 'A', milestone: true },
  ...
  thief: {
    tiers: [
      ...
      { level: 52, label: 'Tier 26', choices: [
        ...
        { id: 'thf_t26b', name: 'Phantom Execution', type: 'active', desc: '6.0x true damage, dodge next 3 attacks', manaCost: 28, multiplier: 6.0, effect: 'phantom_exec', icon: 'A' },
      ...
      { level: 54, label: 'Tier 27', choices: [
        ...
        { id: 'thf_t27b', name: 'Assassins Mark', type: 'active', desc: '7.0x true damage, enemy takes +40% damage for 4 turns', manaCost: 30, multiplier: 7.0, effect: 'assassins_mark', icon: 'A' },
      ...
      { level: 56, label: 'Tier 28', choices: [
        ...
        { id: 'thf_t28b', name: 'Shadow Annihilation', type: 'active', desc: '5.0x true damage 2 times, dodge next 2 attacks', manaCost: 32, multiplier: 5.0, effect: 'shadow_annihilation', icon: 'A' },
      ...
      { level: 58, label: 'Tier 29', choices: [
        ...
        { id: 'thf_t29b', name: 'Oblivion Blade', type: 'active', desc: '8.0x true damage, if enemy below 30% HP instant kill (not bosses)', manaCost: 34, multiplier: 8.0, effect: 'oblivion_blade', icon: 'A' },
      ...
      { level: 60, label: '★ Tier 30', milestone: true, choices: [
        ...
        { id: 'thf_t30b', name: 'Godstrike', type: 'active', desc: '15.0x true damage. Guaranteed critical (4x). Only usable once per battle. Miss = instant death.', manaCost: 45, multiplier: 15.0, effect: 'godstrike', icon: 'A', milestone: true },
      ...
      { level: 62, label: 'Tier 31', choices: [
        ...
        { id: 'thf_t31b', name: 'Death Blossom', type: 'active', desc: '4.5x true damage 3 times, each apply 2 turn poison', manaCost: 34, multiplier: 4.5, effect: 'death_blossom', icon: 'A' },
      ...
      { level: 64, label: 'Tier 32', choices: [
        ...
        { id: 'thf_t32b', name: 'Twilight Strike', type: 'active', desc: '9.0x true damage, dodge next 4 attacks', manaCost: 36, multiplier: 9.0, effect: 'twilight_strike', icon: 'A' },
      ...
      { level: 66, label: 'Tier 33', choices: [
        ...
        { id: 'thf_t33b', name: 'Shadow Maelstrom', type: 'active', desc: '5.0x true damage 3 times, each hit ignores all DEF', manaCost: 38, multiplier: 5.0, effect: 'shadow_maelstrom', icon: 'A' },
      ...
      { level: 68, label: 'Tier 34', choices: [
        ...
        { id: 'thf_t34b', name: 'Void Assassination', type: 'active', desc: '10.0x true damage, if kills refund all mana + dodge 3 attacks', manaCost: 38, multiplier: 10.0, effect: 'void_assassination', icon: 'A' },
      ...
      { level: 70, label: '★ Tier 35', milestone: true, choices: [
        ...
        { id: 'thf_t35b', name: 'Perfect Kill', type: 'active', desc: '25.0x true damage. Guaranteed critical (5x). Costs 50% current HP. If enemy survives, gain +50% dodge for rest of fight.', manaCost: 55, multiplier: 25.0, effect: 'perfect_kill', icon: 'A', milestone: true },
      ...
      { level: 72, label: 'Tier 36', choices: [
        ...
        { id: 'thf_t36b', name: 'Phantasmal Barrage', type: 'active', desc: '6.0x true damage 3 times, dodge next 3 attacks', manaCost: 40, multiplier: 6.0, effect: 'phantasmal_barrage', icon: 'A' },
      ...
      { level: 74, label: 'Tier 37', choices: [
        ...
        { id: 'thf_t37b', name: 'Eclipse Strike', type: 'active', desc: '12.0x true damage, enemy ATK & DEF -40%', manaCost: 42, multiplier: 12.0, effect: 'eclipse_strike', icon: 'A' },
      ...
      { level: 76, label: 'Tier 38', choices: [
        ...
        { id: 'thf_t38b', name: 'Shadow Obliteration', type: 'active', desc: '8.0x true damage 2 times, each hit guaranteed critical', manaCost: 42, multiplier: 8.0, effect: 'shadow_obliteration', icon: 'A' },
      ...
      { level: 78, label: 'Tier 39', choices: [
        ...
        { id: 'thf_t39b', name: 'Annihilation Dance', type: 'active', desc: '7.0x true damage 3 times, dodge all attacks for 2 turns', manaCost: 44, multiplier: 7.0, effect: 'annihilation_dance', icon: 'A' },
      ...
      { level: 80, label: '★ Tier 40', milestone: true, choices: [
        ...
        { id: 'thf_t40b', name: 'Final Assassination', type: 'active', desc: '30.0x true damage. Guaranteed critical (6x). Costs all mana and 50% HP. If enemy dies, fully restore everything.', manaCost: 60, multiplier: 30.0, effect: 'final_assassination', icon: 'A', milestone: true },
      ...
      { level: 82, label: 'Tier 41', choices: [
        ...
        { id: 'thf_t41b', name: 'Phantom Annihilator', type: 'active', desc: '10.0x true damage 2 times, guaranteed crits, dodge 4 attacks', manaCost: 44, multiplier: 10.0, effect: 'phantom_annihilator', icon: 'A' },
      ...
      { level: 84, label: 'Tier 42', choices: [
        ...
        { id: 'thf_t42b', name: 'Shadow Cataclysm', type: 'active', desc: '8.0x true damage 3 times, each apply lethal poison', manaCost: 46, multiplier: 8.0, effect: 'shadow_cataclysm', icon: 'A' },
      ...
      { level: 86, label: 'Tier 43', choices: [
        ...
        { id: 'thf_t43b', name: 'Doom Blade', type: 'active', desc: '14.0x true damage, apply doom for 5 turns, dodge next 3 attacks', manaCost: 44, multiplier: 14.0, effect: 'doom_blade', icon: 'A' },
      ...
      { level: 88, label: 'Tier 44', choices: [
        ...
        { id: 'thf_t44b', name: 'Eternal Night', type: 'active', desc: '10.0x true damage 2 times, guaranteed crits, enemy ATK & DEF -50%', manaCost: 46, multiplier: 10.0, effect: 'eternal_night', icon: 'A' },
      ...
      { level: 90, label: '★ Tier 45', milestone: true, choices: [
        ...
        { id: 'thf_t45b', name: 'Absolute Kill', type: 'active', desc: '40.0x true damage. Guaranteed critical (7x). Costs 80% current HP. If enemy survives at <5% HP, instant kill. The perfect strike.', manaCost: 70, multiplier: 40.0, effect: 'absolute_kill', icon: 'A', milestone: true },
      ...
      { level: 92, label: 'Tier 46', choices: [
        ...
        { id: 'thf_t46b', name: 'Shadow Apocalypse', type: 'active', desc: '10.0x true damage 3 times, guaranteed crits', manaCost: 48, multiplier: 10.0, effect: 'shadow_apocalypse', icon: 'A' },
      ...
      { level: 94, label: 'Tier 47', choices: [
        ...
        { id: 'thf_t47b', name: 'Void Strike', type: 'active', desc: '16.0x true damage, guaranteed critical, dodge 5 attacks', manaCost: 50, multiplier: 16.0, effect: 'void_strike', icon: 'A' },
      ...
      { level: 96, label: 'Tier 48', choices: [
        ...
        { id: 'thf_t48b', name: 'Oblivion Assassination', type: 'active', desc: '12.0x true damage 2 times, guaranteed crits (6x), dodge all for 2 turns', manaCost: 50, multiplier: 12.0, effect: 'oblivion_assassination', icon: 'A' },
      ...
      { level: 98, label: 'Tier 49', choices: [
        ...
        { id: 'thf_t49b', name: 'End of Shadow', type: 'active', desc: '20.0x true damage, guaranteed critical (7x), dodge all attacks for 3 turns', manaCost: 52, multiplier: 20.0, effect: 'end_shadow', icon: 'A' },
      ...
      { level: 100, label: '★ Tier 50', milestone: true, choices: [
        ...
        { id: 'thf_t50b', name: 'Final Shadow', type: 'active', desc: '50.0x true damage. Guaranteed critical (8x). Costs all HP except 1 and all mana. If enemy dies, fully restore. The ultimate assassination.', manaCost: 1, multiplier: 50.0, effect: 'final_shadow', icon: 'A', milestone: true },
  ...
  mage: {
    tiers: [
      ...
      { level: 52, label: 'Tier 26', choices: [
        ...
        { id: 'mag_t26b', name: 'Plasma Bolt', type: 'active', desc: '6.0x true damage, reduce enemy DEF by 50%', manaCost: 28, multiplier: 6.0, effect: 'plasma_bolt', icon: 'A' },
      ...
      { level: 54, label: 'Tier 27', choices: [
        ...
        { id: 'mag_t27b', name: 'Cosmic Blast', type: 'active', desc: '7.0x true damage, enemy ATK & DEF -30%', manaCost: 30, multiplier: 7.0, effect: 'cosmic_blast', icon: 'A' },
      ...
      { level: 56, label: 'Tier 28', choices: [
        ...
        { id: 'mag_t28b', name: 'Void Storm', type: 'active', desc: '5.0x true damage 2 times, drain 15% enemy max HP as mana', manaCost: 32, multiplier: 5.0, effect: 'void_storm', icon: 'A' },
      ...
      { level: 58, label: 'Tier 29', choices: [
        ...
        { id: 'mag_t29b', name: 'Annihilation Beam', type: 'active', desc: '8.0x true damage, ignore all DEF', manaCost: 34, multiplier: 8.0, effect: 'annihilation_beam', icon: 'A' },
      ...
      { level: 60, label: '★ Tier 30', milestone: true, choices: [
        ...
        { id: 'mag_t30b', name: 'Genesis', type: 'active', desc: '15.0x true damage. Restores all mana after cast. Can only be used once per battle. Drains 30% max HP.', manaCost: 45, multiplier: 15.0, effect: 'genesis', icon: 'A', milestone: true },
      ...
      { level: 62, label: 'Tier 31', choices: [
        ...
        { id: 'mag_t31b', name: 'Arcane Devastation', type: 'active', desc: '6.0x true damage 2 times, restore 40% mana spent', manaCost: 32, multiplier: 6.0, effect: 'arcane_devastation', icon: 'A' },
      ...
      { level: 64, label: 'Tier 32', choices: [
        ...
        { id: 'mag_t32b', name: 'Dimensional Collapse', type: 'active', desc: '9.0x true damage, stun 2 turns, enemy ATK & DEF -40%', manaCost: 36, multiplier: 9.0, effect: 'dim_collapse', icon: 'A' },
      ...
      { level: 66, label: 'Tier 33', choices: [
        ...
        { id: 'mag_t33b', name: 'Starburst', type: 'active', desc: '5.0x true damage 3 times', manaCost: 36, multiplier: 5.0, effect: 'starburst', icon: 'A' },
      ...
      { level: 68, label: 'Tier 34', choices: [
        ...
        { id: 'mag_t34b', name: 'Celestial Ray', type: 'active', desc: '10.0x true damage, heal 20% max HP', manaCost: 38, multiplier: 10.0, effect: 'celestial_ray', icon: 'A' },
      ...
      { level: 70, label: '★ Tier 35', milestone: true, choices: [
        ...
        { id: 'mag_t35b', name: 'Cosmic Annihilation', type: 'active', desc: '25.0x true damage. Drains ALL mana. Bonus damage equal to 200% of mana spent. The power of a dying star.', manaCost: 1, multiplier: 25.0, effect: 'cosmic_annihilation', icon: 'A', milestone: true },
      ...
      { level: 72, label: 'Tier 36', choices: [
        ...
        { id: 'mag_t36b', name: 'Arcane Tempest', type: 'active', desc: '7.0x true damage 2 times, restore 50% mana spent', manaCost: 38, multiplier: 7.0, effect: 'arcane_tempest', icon: 'A' },
      ...
      { level: 74, label: 'Tier 37', choices: [
        ...
        { id: 'mag_t37b', name: 'Galactic Storm', type: 'active', desc: '6.0x true damage 3 times, enemy ATK & DEF -40%', manaCost: 42, multiplier: 6.0, effect: 'galactic_storm', icon: 'A' },
      ...
      { level: 76, label: 'Tier 38', choices: [
        ...
        { id: 'mag_t38b', name: 'Reality Tear', type: 'active', desc: '12.0x true damage, stun 1 turn, enemy ATK & DEF -50%', manaCost: 42, multiplier: 12.0, effect: 'reality_tear', icon: 'A' },
      ...
      { level: 78, label: 'Tier 39', choices: [
        ...
        { id: 'mag_t39b', name: 'Celestial Cataclysm', type: 'active', desc: '10.0x true damage 2 times, heal 25% of total damage dealt', manaCost: 44, multiplier: 10.0, effect: 'celestial_cata', icon: 'A' },
      ...
      { level: 80, label: '★ Tier 40', milestone: true, choices: [
        ...
        { id: 'mag_t40b', name: 'Universe End', type: 'active', desc: '30.0x true damage. Costs ALL mana and 60% HP. Bonus damage equal to 300% mana spent. 1 use per battle. The death of stars.', manaCost: 1, multiplier: 30.0, effect: 'universe_end', icon: 'A', milestone: true },
      ...
      { level: 82, label: 'Tier 41', choices: [
        ...
        { id: 'mag_t41b', name: 'Star Destroyer', type: 'active', desc: '10.0x true damage 2 times, restore all mana spent', manaCost: 40, multiplier: 10.0, effect: 'star_destroyer', icon: 'A' },
      ...
      { level: 84, label: 'Tier 42', choices: [
        ...
        { id: 'mag_t42b', name: 'Dimensional Annihilation', type: 'active', desc: '14.0x true damage, ignore all DEF, enemy ATK -50%', manaCost: 44, multiplier: 14.0, effect: 'dim_annihilation', icon: 'A' },
      ...
      { level: 86, label: 'Tier 43', choices: [
        ...
        { id: 'mag_t43b', name: 'Void Annihilation', type: 'active', desc: '8.0x true damage 3 times, drain 20% enemy max HP as mana each hit', manaCost: 46, multiplier: 8.0, effect: 'void_annihilation', icon: 'A' },
      ...
      { level: 88, label: 'Tier 44', choices: [
        ...
        { id: 'mag_t44b', name: 'Creation Blast', type: 'active', desc: '12.0x true damage 2 times, heal 30% of total damage dealt', manaCost: 48, multiplier: 12.0, effect: 'creation_blast', icon: 'A' },
      ...
      { level: 90, label: '★ Tier 45', milestone: true, choices: [
        ...
        { id: 'mag_t45b', name: 'Cosmic Genesis', type: 'active', desc: '40.0x true damage. Costs ALL mana and 70% HP. Bonus damage equal to 500% mana spent. If enemy survives, fully restore mana.', manaCost: 1, multiplier: 40.0, effect: 'cosmic_genesis', icon: 'A', milestone: true },
      ...
      { level: 92, label: 'Tier 46', choices: [
        ...
        { id: 'mag_t46b', name: 'Eternity Blast', type: 'active', desc: '14.0x true damage 2 times, restore all mana', manaCost: 48, multiplier: 14.0, effect: 'eternity_blast', icon: 'A' },
      ...
      { level: 94, label: 'Tier 47', choices: [
        ...
        { id: 'mag_t47b', name: 'Dimensional Rift+', type: 'active', desc: '16.0x true damage, stun 2 turns, immune to damage for 1 turn', manaCost: 50, multiplier: 16.0, effect: 'dim_rift_plus', icon: 'A' },
      ...
      { level: 96, label: 'Tier 48', choices: [
        ...
        { id: 'mag_t48b', name: 'Oblivion Storm', type: 'active', desc: '10.0x true damage 3 times, each hit reduces enemy ATK & DEF by 20%', manaCost: 52, multiplier: 10.0, effect: 'oblivion_storm', icon: 'A' },
      ...
      { level: 98, label: 'Tier 49', choices: [
        ...
        { id: 'mag_t49b', name: 'End of Reality', type: 'active', desc: '20.0x true damage 2 times, ignore all DEF, heal 30% of total damage', manaCost: 54, multiplier: 20.0, effect: 'end_reality', icon: 'A' },
      ...
      { level: 100, label: '★ Tier 50', milestone: true, choices: [
        ...
        { id: 'mag_t50b', name: 'Final Big Bang', type: 'active', desc: '50.0x true damage. Costs ALL mana, ALL HP except 1. Bonus damage equal to 1000% mana spent. If enemy dies, fully restore. The universe reborn.', manaCost: 1, multiplier: 50.0, effect: 'final_big_bang', icon: 'A', milestone: true },
  ...
  necromancer: {
    tiers: [
      ...
      { level: 52, label: 'Tier 26', choices: [
        ...
        { id: 'nec_t26b', name: 'Soul Devastation', type: 'active', desc: '6.0x damage, heal 80% of damage dealt, doom 3 turns', manaCost: 28, multiplier: 6.0, effect: 'soul_devastation', icon: 'A' },
      ...
      { level: 54, label: 'Tier 27', choices: [
        ...
        { id: 'nec_t27b', name: 'Abyssal Nova', type: 'active', desc: '7.0x damage, doom 4 turns, poison 4 turns, heal 30%', manaCost: 30, multiplier: 7.0, effect: 'abyssal_nova', icon: 'A' },
      ...
      { level: 56, label: 'Tier 28', choices: [
        ...
        { id: 'nec_t28b', name: 'Deathstorm', type: 'active', desc: '5.0x damage 2 times, each apply doom 3 turns and poison 3 turns', manaCost: 32, multiplier: 5.0, effect: 'deathstorm', icon: 'A' },
      ...
      { level: 58, label: 'Tier 29', choices: [
        ...
        { id: 'nec_t29b', name: 'Soul Annihilation', type: 'active', desc: '8.0x damage, steal 20% enemy ATK permanently, heal 50%', manaCost: 34, multiplier: 8.0, effect: 'soul_annihilation', icon: 'A' },
      ...
      { level: 60, label: '★ Tier 30', milestone: true, choices: [
        ...
        { id: 'nec_t30b', name: 'Soul Apocalypse+', type: 'active', desc: '15.0x damage. Costs 30% HP. Heals 150% of damage dealt. Dooms for 6 turns. Poisons for 6 turns. The ultimate drain.', manaCost: 45, multiplier: 15.0, effect: 'soul_apocalypse_plus', icon: 'A', milestone: true },
      ...
      { level: 62, label: 'Tier 31', choices: [
        ...
        { id: 'nec_t31b', name: 'Plague Storm', type: 'active', desc: '4.5x damage 3 times, each apply doom 2 turns and poison 2 turns', manaCost: 34, multiplier: 4.5, effect: 'plague_storm', icon: 'A' },
      ...
      { level: 64, label: 'Tier 32', choices: [
        ...
        { id: 'nec_t32b', name: 'Death Ray', type: 'active', desc: '9.0x damage, ignore 60% DEF, heal 60% of damage dealt', manaCost: 36, multiplier: 9.0, effect: 'death_ray', icon: 'A' },
      ...
      { level: 66, label: 'Tier 33', choices: [
        ...
        { id: 'nec_t33b', name: 'Vile Eruption', type: 'active', desc: '7.5x damage, +100% if enemy has 3+ DoT effects', manaCost: 34, multiplier: 7.5, effect: 'vile_eruption', icon: 'A' },
      ...
      { level: 68, label: 'Tier 34', choices: [
        ...
        { id: 'nec_t34b', name: 'Soul Cataclysm', type: 'active', desc: '10.0x damage, doom 5 turns, heal 70% of damage dealt', manaCost: 38, multiplier: 10.0, effect: 'soul_cataclysm', icon: 'A' },
      ...
      { level: 70, label: '★ Tier 35', milestone: true, choices: [
        ...
        { id: 'nec_t35b', name: 'Requiem Eternal', type: 'active', desc: '25.0x damage. Costs 60% HP. Heals 200% of damage. Doom 8 turns. Poison 8 turns. If enemy below 15% after, instant kill.', manaCost: 55, multiplier: 25.0, effect: 'requiem_eternal', icon: 'A', milestone: true },
      ...
      { level: 72, label: 'Tier 36', choices: [
        ...
        { id: 'nec_t36b', name: 'Death Cascade', type: 'active', desc: '6.0x damage 3 times, heal 40% of total damage', manaCost: 38, multiplier: 6.0, effect: 'death_cascade', icon: 'A' },
      ...
      { level: 74, label: 'Tier 37', choices: [
        ...
        { id: 'nec_t37b', name: 'Doomsday Plague', type: 'active', desc: '8.0x damage, doom 6 turns, poison 6 turns, bleed 6 turns, heal 40%', manaCost: 40, multiplier: 8.0, effect: 'doomsday_plague', icon: 'A' },
      ...
      { level: 76, label: 'Tier 38', choices: [
        ...
        { id: 'nec_t38b', name: 'Annihilation Wave', type: 'active', desc: '12.0x damage, doom 5 turns, heal 80% of damage dealt', manaCost: 42, multiplier: 12.0, effect: 'annihilation_wave', icon: 'A' },
      ...
      { level: 78, label: 'Tier 39', choices: [
        ...
        { id: 'nec_t39b', name: 'Soul Oblivion', type: 'active', desc: '10.0x damage 2 times, heal 60% of total damage, doom 4 turns each', manaCost: 44, multiplier: 10.0, effect: 'soul_oblivion', icon: 'A' },
      ...
      { level: 80, label: '★ Tier 40', milestone: true, choices: [
        ...
        { id: 'nec_t40b', name: 'Extinction Requiem', type: 'active', desc: '30.0x damage. Costs 70% HP. Heals 300% of damage dealt. Doom and poison for 10 turns. If enemy survives at <20%, instant kill.', manaCost: 60, multiplier: 30.0, effect: 'extinction_requiem', icon: 'A', milestone: true },
      ...
      { level: 82, label: 'Tier 41', choices: [
        ...
        { id: 'nec_t41b', name: 'Soul Maelstrom', type: 'active', desc: '8.0x damage 3 times, heal 50% of total damage, each apply doom', manaCost: 42, multiplier: 8.0, effect: 'soul_maelstrom', icon: 'A' },
      ...
      { level: 84, label: 'Tier 42', choices: [
        ...
        { id: 'nec_t42b', name: 'Cataclysmic Doom', type: 'active', desc: '14.0x damage, doom 8 turns, poison 8 turns, heal 100% of damage', manaCost: 46, multiplier: 14.0, effect: 'cataclysmic_doom', icon: 'A' },
      ...
      { level: 86, label: 'Tier 43', choices: [
        ...
        { id: 'nec_t43b', name: 'Plague Apocalypse', type: 'active', desc: '8.0x damage 3 times, each apply eternal doom and eternal poison', manaCost: 46, multiplier: 8.0, effect: 'plague_apocalypse', icon: 'A' },
      ...
      { level: 88, label: 'Tier 44', choices: [
        ...
        { id: 'nec_t44b', name: 'Soul Devastation+', type: 'active', desc: '12.0x damage 2 times, heal 80% of total damage, doom 6 turns each', manaCost: 48, multiplier: 12.0, effect: 'soul_devastation_plus', icon: 'A' },
      ...
      { level: 90, label: '★ Tier 45', milestone: true, choices: [
        ...
        { id: 'nec_t45b', name: 'Final Requiem', type: 'active', desc: '40.0x damage. Costs 80% HP. Heals 500% of damage dealt. Doom and poison forever. If enemy below 25% after, instant kill. The song that ends worlds.', manaCost: 70, multiplier: 40.0, effect: 'final_requiem', icon: 'A', milestone: true },
      ...
      { level: 92, label: 'Tier 46', choices: [
        ...
        { id: 'nec_t46b', name: 'Oblivion Plague', type: 'active', desc: '10.0x damage 3 times, each apply eternal doom and poison, heal 50% total', manaCost: 50, multiplier: 10.0, effect: 'oblivion_plague', icon: 'A' },
      ...
      { level: 94, label: 'Tier 47', choices: [
        ...
        { id: 'nec_t47b', name: 'Death Incarnation', type: 'active', desc: '16.0x damage, doom forever, heal 100% of damage, steal 20% enemy ATK', manaCost: 52, multiplier: 16.0, effect: 'death_incarnation', icon: 'A' },
      ...
      { level: 96, label: 'Tier 48', choices: [
        ...
        { id: 'nec_t48b', name: 'Apocalypse Eternal', type: 'active', desc: '12.0x damage 3 times, heal 70% total, doom and poison forever each hit', manaCost: 54, multiplier: 12.0, effect: 'apocalypse_eternal', icon: 'A' },
      ...
      { level: 98, label: 'Tier 49', choices: [
        ...
        { id: 'nec_t49b', name: 'End of Death', type: 'active', desc: '20.0x damage, heal 200% of damage dealt, doom and poison forever, steal 30% enemy ATK', manaCost: 56, multiplier: 20.0, effect: 'end_of_death', icon: 'A' },
      ...
      { level: 100, label: '★ Tier 50', milestone: true, choices: [
        ...
        { id: 'nec_t50b', name: 'Final Requiem Absolute', type: 'active', desc: '50.0x damage. Costs all HP except 1. Heals 1000% of damage dealt. Doom and poison forever. If enemy survives, you gain +200% ATK. The ultimate death song.', manaCost: 1, multiplier: 50.0, effect: 'final_requiem_absolute', icon: 'A', milestone: true },
