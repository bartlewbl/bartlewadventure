  ...
  berserker: {
    tiers: [
      { level: 2, label: 'Tier 1', choices: [
        ...
        { id: 'brs_t1b', name: 'Savage Strike', type: 'active', desc: '1.7x damage, take 5% max HP recoil', manaCost: 8, multiplier: 1.7, effect: 'recoil_small', icon: 'A' },
      ...
      { level: 4, label: 'Tier 2', choices: [
        ...
        { id: 'brs_t2b', name: 'Cleave', type: 'active', desc: '1.4x damage, ignores 30% DEF', manaCost: 10, multiplier: 1.4, effect: 'pierce_30', icon: 'A' },
      ...
      { level: 6, label: 'Tier 3', choices: [
        ...
        { id: 'brs_t3b', name: 'Rampage', type: 'active', desc: '2.3x damage, take 20% max HP recoil', manaCost: 15, multiplier: 2.3, effect: 'recoil_heavy', icon: 'A' },
      ...
      { level: 8, label: 'Tier 4', choices: [
        ...
        { id: 'brs_t4b', name: 'Skull Crusher', type: 'active', desc: '2.3x damage, reduce enemy DEF by 40%', manaCost: 18, multiplier: 2.3, effect: 'shred_def', icon: 'A' },
      ...
      { level: 10, label: 'Tier 5', choices: [
        ...
        { id: 'brs_t5b', name: 'Whirlwind', type: 'active', desc: '1.9x damage, ignores 20% DEF', manaCost: 12, multiplier: 1.9, effect: 'pierce_20', icon: 'A' },
      ...
      { level: 12, label: 'Tier 6', choices: [
        ...
        { id: 'brs_t6b', name: 'Decimate', type: 'active', desc: '2.1x damage, enemy ATK -15%', manaCost: 14, multiplier: 2.1, effect: 'weaken_15', icon: 'A' },
      ...
      { level: 14, label: 'Tier 7', choices: [
        ...
        { id: 'brs_t7b', name: 'Execution', type: 'active', desc: '1.3x damage if enemy below 25% HP, else 1.5x', manaCost: 16, multiplier: 1.3, effect: 'execute_25', icon: 'A' },
      ...
      { level: 16, label: 'Tier 8', choices: [
        ...
        { id: 'brs_t8b', name: 'Devastating Blow', type: 'active', desc: '2.1x damage, ignores 50% DEF', manaCost: 18, multiplier: 2.1, effect: 'pierce_50', icon: 'A' },
      ...
      { level: 18, label: 'Tier 9', choices: [
        ...
        { id: 'brs_t9b', name: 'Blood Nova', type: 'active', desc: '2.5x damage, heal 25% of damage dealt, 10% recoil', manaCost: 22, multiplier: 2.5, effect: 'blood_nova', icon: 'A' },
      ...
      { level: 20, label: 'Tier 10', choices: [
        ...
        { id: 'brs_t10b', name: 'Apocalypse', type: 'active', desc: '3.3x damage, take 30% max HP recoil', manaCost: 28, multiplier: 3.3, effect: 'recoil_extreme', icon: 'A' },
      ...
      { level: 22, label: 'Tier 11', choices: [
        { id: 'brs_t11a', name: 'Gore', type: 'active', desc: '2.3x damage, enemy bleeds 5% max HP/turn for 3 turns', manaCost: 16, multiplier: 2.3, effect: 'apply_bleed', icon: 'A' },
      ...
      { level: 24, label: 'Tier 12', choices: [
        ...
        { id: 'brs_t12b', name: 'Crushing Blow', type: 'active', desc: '2.6x damage, reduce enemy DEF by 60%', manaCost: 20, multiplier: 2.6, effect: 'shred_def_60', icon: 'A' },
      ...
      { level: 26, label: 'Tier 13', choices: [
        ...
        { id: 'brs_t13b', name: 'Reckless Charge', type: 'active', desc: '2.3x damage, ignore 40% DEF, take 10% recoil', manaCost: 18, multiplier: 2.3, effect: 'reckless_charge', icon: 'A' },
      ...
      { level: 28, label: 'Tier 14', choices: [
        ...
        { id: 'brs_t14b', name: 'Annihilate', type: 'active', desc: '1.9x damage if enemy above 50% HP, else 2.5x', manaCost: 24, multiplier: 1.9, effect: 'overkill_50', icon: 'A' },
      ...
      { level: 30, label: '★ Tier 15', milestone: true, choices: [
        ...
        { id: 'brs_t15b', name: 'Worldbreaker', type: 'active', desc: '4.4x damage. 40% recoil. If this kills, fully heal. If it doesn\'t kill, you are stunned next turn.', manaCost: 35, multiplier: 4.4, effect: 'worldbreaker', icon: 'A', milestone: true },
      ...
      { level: 32, label: 'Tier 16', choices: [
        ...
        { id: 'brs_t16b', name: 'Eviscerate', type: 'active', desc: '2.9x damage, ignore 60% DEF', manaCost: 22, multiplier: 2.9, effect: 'pierce_60', icon: 'A' },
      ...
      { level: 34, label: 'Tier 17', choices: [
        ...
        { id: 'brs_t17b', name: 'Cataclysmic Slam', type: 'active', desc: '3.3x damage, shred enemy DEF to 0, take 15% recoil', manaCost: 26, multiplier: 3.3, effect: 'cata_slam', icon: 'A' },
      ...
      { level: 36, label: 'Tier 18', choices: [
        ...
        { id: 'brs_t18b', name: 'Massacre', type: 'active', desc: '2.3x damage three times in a row', manaCost: 30, multiplier: 2.3, effect: 'triple_strike', icon: 'A' },
      ...
      { level: 38, label: 'Tier 19', choices: [
        ...
        { id: 'brs_t19b', name: 'Oblivion Strike', type: 'active', desc: '3.9x true damage, 25% recoil', manaCost: 32, multiplier: 3.9, effect: 'oblivion_strike', icon: 'A' },
      ...
      { level: 40, label: '★ Tier 20', milestone: true, choices: [
        ...
        { id: 'brs_t20b', name: 'Ragnarök', type: 'active', desc: '6.6x damage. Costs 50% current HP + all mana. If enemy survives, your ATK is halved for 3 turns.', manaCost: 40, multiplier: 6.6, effect: 'ragnarok', icon: 'A', milestone: true },
      ...
      { level: 42, label: 'Tier 21', choices: [
        ...
        { id: 'brs_t21b', name: 'Sundering Blow', type: 'active', desc: '3.6x damage, enemy DEF & ATK -30%', manaCost: 28, multiplier: 3.6, effect: 'sunder', icon: 'A' },
      ...
      { level: 44, label: 'Tier 22', choices: [
        ...
        { id: 'brs_t22b', name: 'Titan Blow', type: 'active', desc: '3.9x damage, stun enemy for 1 turn', manaCost: 30, multiplier: 3.9, effect: 'titan_blow', icon: 'A' },
      ...
      { level: 46, label: 'Tier 23', choices: [
        ...
        { id: 'brs_t23b', name: 'Savage Whirlwind', type: 'active', desc: '2.6x damage twice, ignore 30% DEF', manaCost: 28, multiplier: 2.6, effect: 'double_pierce_30', icon: 'A' },
      ...
      { level: 48, label: 'Tier 24', choices: [
        ...
        { id: 'brs_t24b', name: 'Extinction', type: 'active', desc: '3.6x damage, 8.0x if enemy below 30% HP', manaCost: 34, multiplier: 3.6, effect: 'execute_30_8x', icon: 'A' },
      ...
      { level: 50, label: '★ Tier 25', milestone: true, choices: [
        ...
        { id: 'brs_t25b', name: 'Final Cataclysm', type: 'active', desc: '9x damage. Sets your HP to 1. If enemy survives, you die instantly.', manaCost: 50, multiplier: 9, effect: 'final_cataclysm', icon: 'A', milestone: true },
      ...
      { level: 52, label: 'Tier 26', choices: [
        ...
        { id: 'brs_t26b', name: 'Hemorrhaging Slash', type: 'active', desc: '3.9x damage, apply bleed for 5 turns (4% max HP/turn)', manaCost: 28, multiplier: 3.9, effect: 'hemorrhage_5', icon: 'A' },
      ...
      { level: 54, label: 'Tier 27', choices: [
        ...
        { id: 'brs_t27b', name: 'Cataclysmic Fury', type: 'active', desc: '3.9x damage, +50% if below 50% HP', manaCost: 30, multiplier: 3.9, effect: 'cata_fury', icon: 'A' },
      ...
      { level: 56, label: 'Tier 28', choices: [
        ...
        { id: 'brs_t28b', name: 'Titan Rend', type: 'active', desc: '4.4x damage, ignore 70% DEF, 10% recoil', manaCost: 34, multiplier: 4.4, effect: 'titan_rend', icon: 'A' },
      ...
      { level: 58, label: 'Tier 29', choices: [
        ...
        { id: 'brs_t29b', name: 'Oblivion Cleave', type: 'active', desc: '3.3x damage twice, ignore 40% DEF each hit', manaCost: 32, multiplier: 3.3, effect: 'double_pierce_40', icon: 'A' },
      ...
      { level: 60, label: '★ Tier 30', milestone: true, choices: [
        ...
        { id: 'brs_t30b', name: 'Armageddon Strike', type: 'active', desc: '6.8x damage. Costs 40% current HP. If enemy dies, restore all HP. If not, stunned 2 turns.', manaCost: 45, multiplier: 6.8, effect: 'armageddon_strike', icon: 'A', milestone: true },
      ...
      { level: 62, label: 'Tier 31', choices: [
        ...
        { id: 'brs_t31b', name: 'Savage Onslaught', type: 'active', desc: '2.9x damage 3 times', manaCost: 34, multiplier: 2.9, effect: 'triple_strike_45', icon: 'A' },
      ...
      { level: 64, label: 'Tier 32', choices: [
        ...
        { id: 'brs_t32b', name: 'World Render', type: 'active', desc: '5x damage, shred enemy DEF to 0, 15% recoil', manaCost: 36, multiplier: 5, effect: 'world_render', icon: 'A' },
      ...
      { level: 66, label: 'Tier 33', choices: [
        ...
        { id: 'brs_t33b', name: 'Infernal Blow', type: 'active', desc: '4.1x damage, enemy ATK & DEF -40%', manaCost: 32, multiplier: 4.1, effect: 'infernal_blow', icon: 'A' },
      ...
      { level: 68, label: 'Tier 34', choices: [
        ...
        { id: 'brs_t34b', name: 'Decimating Fury', type: 'active', desc: '3.9x damage twice, each hit ignores 50% DEF', manaCost: 36, multiplier: 3.9, effect: 'double_pierce_50', icon: 'A' },
      ...
      { level: 70, label: '★ Tier 35', milestone: true, choices: [
        ...
        { id: 'brs_t35b', name: 'Extinction Blow', type: 'active', desc: '8.8x damage. Costs 60% current HP. If enemy survives, your ATK is halved permanently. All or nothing.', manaCost: 55, multiplier: 8.8, effect: 'extinction_blow', icon: 'A', milestone: true },
      ...
      { level: 72, label: 'Tier 36', choices: [
        ...
        { id: 'brs_t36b', name: 'Cataclysm Wave', type: 'active', desc: '4.7x damage, enemy DEF & ATK -50%', manaCost: 38, multiplier: 4.7, effect: 'cata_wave', icon: 'A' },
      ...
      { level: 74, label: 'Tier 37', choices: [
        ...
        { id: 'brs_t37b', name: 'Annihilation Slam', type: 'active', desc: '5.5x damage, 20% recoil, ignore all DEF', manaCost: 40, multiplier: 5.5, effect: 'annihilation_slam', icon: 'A' },
      ...
      { level: 76, label: 'Tier 38', choices: [
        ...
        { id: 'brs_t38b', name: 'Doomsday Cleave', type: 'active', desc: '3.9x damage 2 times, bleed 5 turns each', manaCost: 38, multiplier: 3.9, effect: 'doom_cleave', icon: 'A' },
      ...
      { level: 78, label: 'Tier 39', choices: [
        ...
        { id: 'brs_t39b', name: 'Primordial Rage', type: 'active', desc: '6.6x damage, heal 30% of damage dealt, ignore 60% DEF', manaCost: 42, multiplier: 6.6, effect: 'primordial_rage', icon: 'A' },
      ...
      { level: 80, label: '★ Tier 40', milestone: true, choices: [
        ...
        { id: 'brs_t40b', name: 'Ragnarök Reborn', type: 'active', desc: '6.8x damage. Costs 70% current HP and all mana. If enemy dies, fully heal and restore all mana. If not, ATK halved rest of fight.', manaCost: 60, multiplier: 6.8, effect: 'ragnarok_reborn', icon: 'A', milestone: true },
      ...
      { level: 82, label: 'Tier 41', choices: [
        ...
        { id: 'brs_t41b', name: 'Godslayer Strike', type: 'active', desc: '5.5x damage, ignore all DEF, enemy ATK -30%', manaCost: 40, multiplier: 5.5, effect: 'godslayer_strike', icon: 'A' },
      ...
      { level: 84, label: 'Tier 42', choices: [
        ...
        { id: 'brs_t42b', name: 'Apocalyptic Rampage', type: 'active', desc: '3.9x damage 3 times, 10% recoil', manaCost: 42, multiplier: 3.9, effect: 'apoc_rampage', icon: 'A' },
      ...
      { level: 86, label: 'Tier 43', choices: [
        ...
        { id: 'brs_t43b', name: 'World Ender', type: 'active', desc: '6.3x damage, shred enemy DEF to 0, 15% recoil', manaCost: 44, multiplier: 6.3, effect: 'world_ender', icon: 'A' },
      ...
      { level: 88, label: 'Tier 44', choices: [
        ...
        { id: 'brs_t44b', name: 'Cataclysmic Rend', type: 'active', desc: '4.4x damage twice, ignore 70% DEF each', manaCost: 44, multiplier: 4.4, effect: 'double_pierce_70', icon: 'A' },
      ...
      { level: 90, label: '★ Tier 45', milestone: true, choices: [
        ...
        { id: 'brs_t45b', name: 'Extinction Event', type: 'active', desc: '9.1x damage. Costs 80% current HP. Sets mana to 0. If enemy survives, fight continues but you cannot use skills for 3 turns.', manaCost: 70, multiplier: 9.1, effect: 'extinction_event_brs', icon: 'A', milestone: true },
      ...
      { level: 92, label: 'Tier 46', choices: [
        ...
        { id: 'brs_t46b', name: 'Divine Rampage', type: 'active', desc: '5.5x damage 2 times, heal 20% of total damage', manaCost: 44, multiplier: 5.5, effect: 'divine_rampage', icon: 'A' },
      ...
      { level: 94, label: 'Tier 47', choices: [
        ...
        { id: 'brs_t47b', name: 'Apocalypse Incarnate', type: 'active', desc: '7.2x damage, enemy ATK & DEF -60%, 20% recoil', manaCost: 48, multiplier: 7.2, effect: 'apoc_incarnate', icon: 'A' },
      ...
      { level: 96, label: 'Tier 48', choices: [
        ...
        { id: 'brs_t48b', name: 'Oblivion Rampage', type: 'active', desc: '4.4x true damage 3 times', manaCost: 50, multiplier: 4.4, effect: 'oblivion_rampage', icon: 'A' },
      ...
      { level: 98, label: 'Tier 49', choices: [
        ...
        { id: 'brs_t49b', name: 'End of All Things', type: 'active', desc: '9x damage, ignore all DEF, heal 50% of damage dealt', manaCost: 52, multiplier: 9, effect: 'end_all_things', icon: 'A' },
      ...
      { level: 100, label: '★ Tier 50', milestone: true, choices: [
        ...
        { id: 'brs_t50b', name: 'Final Ragnarök', type: 'active', desc: '10x damage. Costs all HP except 1 and all mana. If enemy dies, fully restore everything. If not, you die. The ultimate gamble.', manaCost: 1, multiplier: 10, effect: 'final_ragnarok', icon: 'A', milestone: true },
  ...
  warrior: {
    tiers: [
      { level: 2, label: 'Tier 1', choices: [
        ...
        { id: 'war_t1b', name: 'War Cry', type: 'active', desc: 'Reduce enemy ATK by 25% for the fight', manaCost: 8, multiplier: 0.7, effect: 'war_cry', icon: 'A' },
      ...
      { level: 4, label: 'Tier 2', choices: [
        ...
        { id: 'war_t2b', name: 'Counter Strike', type: 'active', desc: '1.5x damage, 2.5x if defended last turn', manaCost: 10, multiplier: 1.5, effect: 'counter', icon: 'A' },
      ...
      { level: 6, label: 'Tier 3', choices: [
        ...
        { id: 'war_t3b', name: 'Earthquake', type: 'active', desc: '1.7x damage, lower enemy DEF by 30%', manaCost: 15, multiplier: 1.7, effect: 'quake', icon: 'A' },
      ...
      { level: 8, label: 'Tier 4', choices: [
        ...
        { id: 'war_t4b', name: 'Final Stand', type: 'active', desc: '2.1x damage, heal 30% of damage dealt', manaCost: 18, multiplier: 2.1, effect: 'final_stand', icon: 'A' },
      ...
      { level: 10, label: 'Tier 5', choices: [
        ...
        { id: 'war_t5b', name: 'Shield Slam', type: 'active', desc: '1.4x damage + DEF added to ATK for this hit', manaCost: 12, multiplier: 1.4, effect: 'shield_slam', icon: 'A' },
      ...
      { level: 12, label: 'Tier 6', choices: [
        ...
        { id: 'war_t6b', name: 'Heroic Strike', type: 'active', desc: '1.9x damage, restore 5 mana', manaCost: 10, multiplier: 1.9, effect: 'heroic_mana', icon: 'A' },
      ...
      { level: 14, label: 'Tier 7', choices: [
        ...
        { id: 'war_t7b', name: 'Mighty Cleave', type: 'active', desc: '2x damage, ignores 25% DEF', manaCost: 14, multiplier: 2, effect: 'pierce_25', icon: 'A' },
      ...
      { level: 16, label: 'Tier 8', choices: [
        ...
        { id: 'war_t8b', name: 'Rallying Blow', type: 'active', desc: '1.7x damage, heal 20% max HP', manaCost: 16, multiplier: 1.7, effect: 'rally_heal', icon: 'A' },
      ...
      { level: 18, label: 'Tier 9', choices: [
        ...
        { id: 'war_t9b', name: 'Colossus Smash', type: 'active', desc: '2.3x damage, reduce enemy DEF to 0 for 2 turns', manaCost: 22, multiplier: 2.3, effect: 'armor_break', icon: 'A' },
      ...
      { level: 20, label: 'Tier 10', choices: [
        ...
        { id: 'war_t10b', name: 'Avatar of War', type: 'active', desc: '2.6x damage, +50% DEF for 3 turns', manaCost: 28, multiplier: 2.6, effect: 'avatar', icon: 'A' },
      ...
      { level: 22, label: 'Tier 11', choices: [
        ...
        { id: 'war_t11b', name: 'Thunder Clap', type: 'active', desc: '1.9x damage, enemy ATK -35% for the fight', manaCost: 16, multiplier: 1.9, effect: 'thunder_clap', icon: 'A' },
      ...
      { level: 24, label: 'Tier 12', choices: [
        ...
        { id: 'war_t12b', name: 'Retribution', type: 'active', desc: '2.3x damage, 4.0x if you defended last turn', manaCost: 18, multiplier: 2.3, effect: 'retribution', icon: 'A' },
      ...
      { level: 26, label: 'Tier 13', choices: [
        ...
        { id: 'war_t13b', name: 'Seismic Slam', type: 'active', desc: '2.3x damage, reduce enemy DEF by 50%', manaCost: 20, multiplier: 2.3, effect: 'seismic_slam', icon: 'A' },
      ...
      { level: 28, label: 'Tier 14', choices: [
        ...
        { id: 'war_t14b', name: 'Devastate', type: 'active', desc: '2.9x damage, heal 25% of damage dealt', manaCost: 22, multiplier: 2.9, effect: 'devastate_heal', icon: 'A' },
      ...
      { level: 30, label: '★ Tier 15', milestone: true, choices: [
        ...
        { id: 'war_t15b', name: 'Wrath of the Ancients', type: 'active', desc: '3.9x damage. Consumes all DEF for this fight — DEF becomes 0. Damage scales with lost DEF.', manaCost: 35, multiplier: 3.9, effect: 'wrath_ancients', icon: 'A', milestone: true },
      ...
      { level: 32, label: 'Tier 16', choices: [
        ...
        { id: 'war_t16b', name: 'Warbringer', type: 'active', desc: '2.6x damage, gain +20% ATK for rest of fight', manaCost: 22, multiplier: 2.6, effect: 'warbringer', icon: 'A' },
      ...
      { level: 34, label: 'Tier 17', choices: [
        ...
        { id: 'war_t17b', name: 'Judgment', type: 'active', desc: '3.3x damage, enemy ATK and DEF -25%', manaCost: 26, multiplier: 3.3, effect: 'judgment', icon: 'A' },
      ...
      { level: 36, label: 'Tier 18', choices: [
        ...
        { id: 'war_t18b', name: 'Colossal Strike', type: 'active', desc: '3.6x damage, DEF added to ATK for this hit', manaCost: 28, multiplier: 3.6, effect: 'colossal_strike', icon: 'A' },
      ...
      { level: 38, label: 'Tier 19', choices: [
        ...
        { id: 'war_t19b', name: 'Titanic Slam', type: 'active', desc: '3.9x damage, stun enemy 1 turn, ignore 30% DEF', manaCost: 30, multiplier: 3.9, effect: 'titanic_slam', icon: 'A' },
      ...
      { level: 40, label: '★ Tier 20', milestone: true, choices: [
        ...
        { id: 'war_t20b', name: 'Cataclysm of Steel', type: 'active', desc: '5.5x damage. Shatters your armor — DEF halved for rest of fight. If enemy dies, DEF is fully restored.', manaCost: 40, multiplier: 5.5, effect: 'cataclysm_steel', icon: 'A', milestone: true },
      ...
      { level: 42, label: 'Tier 21', choices: [
        ...
        { id: 'war_t21b', name: 'Punishing Strike', type: 'active', desc: '2.9x damage, heal 15% max HP, restore 8 mana', manaCost: 24, multiplier: 2.9, effect: 'punishing_strike', icon: 'A' },
      ...
      { level: 44, label: 'Tier 22', choices: [
        ...
        { id: 'war_t22b', name: 'Bladestorm', type: 'active', desc: '2.3x damage three times', manaCost: 28, multiplier: 2.3, effect: 'triple_strike', icon: 'A' },
      ...
      { level: 46, label: 'Tier 23', choices: [
        ...
        { id: 'war_t23b', name: 'Sundering Cleave', type: 'active', desc: '3.6x damage, reduce enemy DEF to 0', manaCost: 30, multiplier: 3.6, effect: 'full_armor_break', icon: 'A' },
      ...
      { level: 48, label: 'Tier 24', choices: [
        ...
        { id: 'war_t24b', name: 'Worldsplitter', type: 'active', desc: '3.9x damage, ignore 50% DEF, gain 15% max HP as shield', manaCost: 34, multiplier: 3.9, effect: 'worldsplitter', icon: 'A' },
      ...
      { level: 50, label: '★ Tier 25', milestone: true, choices: [
        ...
        { id: 'war_t25b', name: 'Final Judgment', type: 'active', desc: '6.8x damage. For the rest of the fight, you take double damage. If enemy survives, heal to full.', manaCost: 50, multiplier: 6.8, effect: 'final_judgment', icon: 'A', milestone: true },
      ...
      { level: 52, label: 'Tier 26', choices: [
        ...
        { id: 'war_t26b', name: 'Divine Strike', type: 'active', desc: '3.9x damage, gain +25% DEF for rest of fight', manaCost: 28, multiplier: 3.9, effect: 'divine_strike', icon: 'A' },
      ...
      { level: 54, label: 'Tier 27', choices: [
        ...
        { id: 'war_t27b', name: 'Hammer of Justice', type: 'active', desc: '3.9x damage, stun enemy 2 turns', manaCost: 30, multiplier: 3.9, effect: 'hammer_justice', icon: 'A' },
      ...
      { level: 56, label: 'Tier 28', choices: [
        ...
        { id: 'war_t28b', name: 'Titanic Crush', type: 'active', desc: '4.4x damage, DEF added to ATK for this hit, stun 1 turn', manaCost: 32, multiplier: 4.4, effect: 'titanic_crush', icon: 'A' },
      ...
      { level: 58, label: 'Tier 29', choices: [
        ...
        { id: 'war_t29b', name: 'Champions Blow', type: 'active', desc: '3.6x damage twice, heal 15% max HP', manaCost: 32, multiplier: 3.6, effect: 'champions_blow', icon: 'A' },
      ...
      { level: 60, label: '★ Tier 30', milestone: true, choices: [
        ...
        { id: 'war_t30b', name: 'Judgment of Ages', type: 'active', desc: '6.8x damage. DEF added to ATK. Shatters your DEF to 0 for 3 turns. If enemy dies, DEF fully restored and doubled.', manaCost: 45, multiplier: 6.8, effect: 'judgment_ages', icon: 'A', milestone: true },
      ...
      { level: 62, label: 'Tier 31', choices: [
        ...
        { id: 'war_t31b', name: 'Seismic Wave', type: 'active', desc: '3.6x damage, enemy ATK & DEF -40%', manaCost: 30, multiplier: 3.6, effect: 'seismic_wave', icon: 'A' },
      ...
      { level: 64, label: 'Tier 32', choices: [
        ...
        { id: 'war_t32b', name: 'Executioners Judgment', type: 'active', desc: '5x damage, 12.0x if enemy below 30% HP', manaCost: 34, multiplier: 5, effect: 'exec_judgment', icon: 'A' },
      ...
      { level: 66, label: 'Tier 33', choices: [
        ...
        { id: 'war_t33b', name: 'Avalanche', type: 'active', desc: '3.3x damage 3 times, enemy DEF -20% each hit', manaCost: 36, multiplier: 3.3, effect: 'avalanche', icon: 'A' },
      ...
      { level: 68, label: 'Tier 34', choices: [
        ...
        { id: 'war_t34b', name: 'Cataclysmic Judgment', type: 'active', desc: '5.5x damage, DEF added to ATK, ignore 50% enemy DEF', manaCost: 38, multiplier: 5.5, effect: 'cata_judgment', icon: 'A' },
      ...
      { level: 70, label: '★ Tier 35', milestone: true, choices: [
        ...
        { id: 'war_t35b', name: 'World Sunder', type: 'active', desc: '8.8x damage. Consumes all DEF permanently. If enemy dies, DEF is tripled from base. The ultimate sacrifice strike.', manaCost: 55, multiplier: 8.8, effect: 'world_sunder', icon: 'A', milestone: true },
      ...
      { level: 72, label: 'Tier 36', choices: [
        ...
        { id: 'war_t36b', name: 'Holy Retribution', type: 'active', desc: '4.4x damage, heal 30% max HP, +20% DEF for 3 turns', manaCost: 36, multiplier: 4.4, effect: 'holy_retribution', icon: 'A' },
      ...
      { level: 74, label: 'Tier 37', choices: [
        ...
        { id: 'war_t37b', name: 'Judgment Storm', type: 'active', desc: '3.9x damage 3 times', manaCost: 40, multiplier: 3.9, effect: 'judgment_storm', icon: 'A' },
      ...
      { level: 76, label: 'Tier 38', choices: [
        ...
        { id: 'war_t38b', name: 'Worldbreaker Slam', type: 'active', desc: '6.6x damage, shred enemy DEF to 0, stun 1 turn', manaCost: 42, multiplier: 6.6, effect: 'worldbreaker_slam', icon: 'A' },
      ...
      { level: 78, label: 'Tier 39', choices: [
        ...
        { id: 'war_t39b', name: 'Heaven Splitter', type: 'active', desc: '5.5x damage, heal 25% damage dealt, ignore 60% DEF', manaCost: 40, multiplier: 5.5, effect: 'heaven_splitter', icon: 'A' },
      ...
      { level: 80, label: '★ Tier 40', milestone: true, choices: [
        ...
        { id: 'war_t40b', name: 'Final Crusade', type: 'active', desc: '6.8x damage. DEF doubled and added to ATK. After use, DEF becomes 0 permanently. One legendary strike.', manaCost: 60, multiplier: 6.8, effect: 'final_crusade', icon: 'A', milestone: true },
      ...
      { level: 82, label: 'Tier 41', choices: [
        ...
        { id: 'war_t41b', name: 'Decimation Strike', type: 'active', desc: '4.4x damage twice, +30% DEF for rest of fight', manaCost: 40, multiplier: 4.4, effect: 'decimation_strike', icon: 'A' },
      ...
      { level: 84, label: 'Tier 42', choices: [
        ...
        { id: 'war_t42b', name: 'Divine Retribution', type: 'active', desc: '5.5x damage, 15.0x if you defended last turn', manaCost: 38, multiplier: 5.5, effect: 'divine_retribution', icon: 'A' },
      ...
      { level: 86, label: 'Tier 43', choices: [
        ...
        { id: 'war_t43b', name: 'Apocalyptic Judgment', type: 'active', desc: '6.3x damage, enemy ATK & DEF -50%, heal 20% max HP', manaCost: 44, multiplier: 6.3, effect: 'apoc_judgment', icon: 'A' },
      ...
      { level: 88, label: 'Tier 44', choices: [
        ...
        { id: 'war_t44b', name: 'Titans Judgment', type: 'active', desc: '6.6x damage, stun 2 turns, heal 30% of damage dealt', manaCost: 46, multiplier: 6.6, effect: 'titans_judgment', icon: 'A' },
      ...
      { level: 90, label: '★ Tier 45', milestone: true, choices: [
        ...
        { id: 'war_t45b', name: 'Cataclysm of the Gods', type: 'active', desc: '9.1x damage. Consumes all DEF and 50% HP. If enemy dies, all stats tripled for rest of run. If not, DEF stays at 0.', manaCost: 70, multiplier: 9.1, effect: 'cata_gods', icon: 'A', milestone: true },
      ...
      { level: 92, label: 'Tier 46', choices: [
        ...
        { id: 'war_t46b', name: 'Divine Annihilation', type: 'active', desc: '6.3x damage, +20.0x if defended last turn', manaCost: 46, multiplier: 6.3, effect: 'divine_annihilation', icon: 'A' },
      ...
      { level: 94, label: 'Tier 47', choices: [
        ...
        { id: 'war_t47b', name: 'Worldshatter', type: 'active', desc: '5.5x damage 2 times, ignore all DEF', manaCost: 48, multiplier: 5.5, effect: 'worldshatter', icon: 'A' },
      ...
      { level: 96, label: 'Tier 48', choices: [
        ...
        { id: 'war_t48b', name: 'Judgment Absolute', type: 'active', desc: '7.2x damage, heal 40% of damage dealt, enemy ATK & DEF -60%', manaCost: 50, multiplier: 7.2, effect: 'judgment_absolute', icon: 'A' },
      ...
      { level: 98, label: 'Tier 49', choices: [
        ...
        { id: 'war_t49b', name: 'Divine Cataclysm', type: 'active', desc: '9x damage, DEF tripled and added to ATK for this hit', manaCost: 52, multiplier: 9, effect: 'divine_cataclysm', icon: 'A' },
      ...
      { level: 100, label: '★ Tier 50', milestone: true, choices: [
        ...
        { id: 'war_t50b', name: 'Final Judgment Absolute', type: 'active', desc: '10x damage. DEF quintupled and added to ATK. Permanently destroys all DEF after. The ultimate sacrifice for the ultimate strike.', manaCost: 1, multiplier: 10, effect: 'final_judgment_absolute', icon: 'A', milestone: true },
  ...
  thief: {
    tiers: [
      { level: 2, label: 'Tier 1', choices: [
        ...
        { id: 'thf_t1b', name: 'Poison Blade', type: 'active', desc: '1.3x damage, poison enemy for 3 turns', manaCost: 8, multiplier: 1.3, effect: 'apply_poison', icon: 'A' },
      ...
      { level: 4, label: 'Tier 2', choices: [
        ...
        { id: 'thf_t2b', name: 'Assassinate', type: 'active', desc: '1.3x damage if enemy <30% HP, else 1.5x', manaCost: 10, multiplier: 1.3, effect: 'execute', icon: 'A' },
      ...
      { level: 6, label: 'Tier 3', choices: [
        ...
        { id: 'thf_t3b', name: 'Shadow Dance', type: 'active', desc: '1.5x damage, dodge the next enemy attack', manaCost: 15, multiplier: 1.5, effect: 'shadow_dance', icon: 'A' },
      ...
      { level: 8, label: 'Tier 4', choices: [
        ...
        { id: 'thf_t4b', name: 'Death Mark', type: 'active', desc: '1.9x damage, ignores all enemy DEF', manaCost: 18, multiplier: 1.9, effect: 'true_damage', icon: 'A' },
      ...
      { level: 10, label: 'Tier 5', choices: [
        ...
        { id: 'thf_t5b', name: 'Fan of Knives', type: 'active', desc: '1.5x damage, apply poison for 2 turns', manaCost: 10, multiplier: 1.5, effect: 'apply_poison_short', icon: 'A' },
      ...
      { level: 12, label: 'Tier 6', choices: [
        ...
        { id: 'thf_t6b', name: 'Cheap Shot', type: 'active', desc: '1.4x damage, reduce enemy ATK by 20%', manaCost: 10, multiplier: 1.4, effect: 'cheap_shot', icon: 'A' },
      ...
      { level: 14, label: 'Tier 7', choices: [
        ...
        { id: 'thf_t7b', name: 'Garrote', type: 'active', desc: '1.7x damage, strong poison for 3 turns', manaCost: 14, multiplier: 1.7, effect: 'strong_poison_3', icon: 'A' },
      ...
      { level: 16, label: 'Tier 8', choices: [
        ...
        { id: 'thf_t8b', name: 'Ambush', type: 'active', desc: '2.3x damage, ignores 50% DEF', manaCost: 16, multiplier: 2.3, effect: 'pierce_50', icon: 'A' },
      ...
      { level: 18, label: 'Tier 9', choices: [
        ...
        { id: 'thf_t9b', name: 'Shadowstrike', type: 'active', desc: '2.3x damage, dodge next 2 attacks', manaCost: 22, multiplier: 2.3, effect: 'shadow_dance_2', icon: 'A' },
      ...
      { level: 20, label: 'Tier 10', choices: [
        ...
        { id: 'thf_t10b', name: 'Phantom Blade', type: 'active', desc: '2.9x true damage, dodge next attack', manaCost: 28, multiplier: 2.9, effect: 'phantom_blade', icon: 'A' },
      ...
      { level: 22, label: 'Tier 11', choices: [
        ...
        { id: 'thf_t11b', name: 'Kidney Shot', type: 'active', desc: '1.9x damage, stun enemy for 1 turn', manaCost: 14, multiplier: 1.9, effect: 'stun_1', icon: 'A' },
      ...
      { level: 24, label: 'Tier 12', choices: [
        ...
        { id: 'thf_t12b', name: 'Backstab', type: 'active', desc: '1.5x true damage if you dodged last turn, else 2.0x', manaCost: 18, multiplier: 1.5, effect: 'backstab', icon: 'A' },
      ...
      { level: 26, label: 'Tier 13', choices: [
        ...
        { id: 'thf_t13b', name: 'Toxic Barrage', type: 'active', desc: '1.5x damage 3 times, each applies 1 turn poison', manaCost: 20, multiplier: 1.5, effect: 'toxic_barrage', icon: 'A' },
      ...
      { level: 28, label: 'Tier 14', choices: [
        ...
        { id: 'thf_t14b', name: 'Marked for Death', type: 'active', desc: '2.3x damage, enemy takes +25% damage for 3 turns', manaCost: 20, multiplier: 2.3, effect: 'mark_death', icon: 'A' },
      ...
      { level: 30, label: '★ Tier 15', milestone: true, choices: [
        ...
        { id: 'thf_t15b', name: 'Death Sentence', type: 'active', desc: '5.5x true damage. Can only be used once per battle. If enemy survives, they gain +50% ATK.', manaCost: 35, multiplier: 5.5, effect: 'death_sentence', icon: 'A', milestone: true },
      ...
      { level: 32, label: 'Tier 16', choices: [
        ...
        { id: 'thf_t16b', name: 'Shadow Assault', type: 'active', desc: '2.9x true damage, dodge next 2 attacks', manaCost: 24, multiplier: 2.9, effect: 'shadow_assault', icon: 'A' },
      ...
      { level: 34, label: 'Tier 17', choices: [
        ...
        { id: 'thf_t17b', name: 'Hemorrhage', type: 'active', desc: '2.3x damage, strong bleed for 4 turns', manaCost: 20, multiplier: 2.3, effect: 'hemorrhage', icon: 'A' },
      ...
      { level: 36, label: 'Tier 18', choices: [
        ...
        { id: 'thf_t18b', name: "Assassin's Creed", type: 'active', desc: '3.3x true damage, if enemy below 25% HP instant kill (not bosses)', manaCost: 26, multiplier: 3.3, effect: 'assassin_creed', icon: 'A' },
      ...
      { level: 38, label: 'Tier 19', choices: [
        ...
        { id: 'thf_t19b', name: 'Phantom Storm', type: 'active', desc: '2.3x true damage 2 times, dodge next attack', manaCost: 28, multiplier: 2.3, effect: 'phantom_storm', icon: 'A' },
      ...
      { level: 40, label: '★ Tier 20', milestone: true, choices: [
        ...
        { id: 'thf_t20b', name: 'Coup de Grâce', type: 'active', desc: '6.8x true damage. Usable only when enemy is below 30% HP. Miss threshold = instant death for you.', manaCost: 40, multiplier: 6.8, effect: 'coup_de_grace', icon: 'A', milestone: true },
      ...
      { level: 42, label: 'Tier 21', choices: [
        ...
        { id: 'thf_t21b', name: 'Execution Chain', type: 'active', desc: '3.3x damage, if kill refund all mana spent', manaCost: 26, multiplier: 3.3, effect: 'execution_chain', icon: 'A' },
      ...
      { level: 44, label: 'Tier 22', choices: [
        ...
        { id: 'thf_t22b', name: 'Viper Strike', type: 'active', desc: '2.6x true damage, lethal poison for 4 turns', manaCost: 24, multiplier: 2.6, effect: 'viper_strike', icon: 'A' },
      ...
      { level: 46, label: 'Tier 23', choices: [
        ...
        { id: 'thf_t23b', name: 'Shadow Barrage', type: 'active', desc: '2.3x true damage 3 times', manaCost: 30, multiplier: 2.3, effect: 'shadow_barrage', icon: 'A' },
      ...
      { level: 48, label: 'Tier 24', choices: [
        ...
        { id: 'thf_t24b', name: 'Dance of Death', type: 'active', desc: '3.9x true damage, dodge next 3 attacks', manaCost: 32, multiplier: 3.9, effect: 'dance_death', icon: 'A' },
      ...
      { level: 50, label: '★ Tier 25', milestone: true, choices: [
        ...
        { id: 'thf_t25b', name: 'Perfect Assassination', type: 'active', desc: '8.8x true damage. Only usable at full HP. Sets you to 1 HP after use. If enemy survives, fight continues normally.', manaCost: 50, multiplier: 8.8, effect: 'perfect_assassination', icon: 'A', milestone: true },
      ...
      { level: 52, label: 'Tier 26', choices: [
        ...
        { id: 'thf_t26b', name: 'Phantom Execution', type: 'active', desc: '3.9x true damage, dodge next 3 attacks', manaCost: 28, multiplier: 3.9, effect: 'phantom_exec', icon: 'A' },
      ...
      { level: 54, label: 'Tier 27', choices: [
        ...
        { id: 'thf_t27b', name: 'Assassins Mark', type: 'active', desc: '3.9x true damage, enemy takes +40% damage for 4 turns', manaCost: 30, multiplier: 3.9, effect: 'assassins_mark', icon: 'A' },
      ...
      { level: 56, label: 'Tier 28', choices: [
        ...
        { id: 'thf_t28b', name: 'Shadow Annihilation', type: 'active', desc: '3.3x true damage 2 times, dodge next 2 attacks', manaCost: 32, multiplier: 3.3, effect: 'shadow_annihilation', icon: 'A' },
      ...
      { level: 58, label: 'Tier 29', choices: [
        ...
        { id: 'thf_t29b', name: 'Oblivion Blade', type: 'active', desc: '4.4x true damage, if enemy below 30% HP instant kill (not bosses)', manaCost: 34, multiplier: 4.4, effect: 'oblivion_blade', icon: 'A' },
      ...
      { level: 60, label: '★ Tier 30', milestone: true, choices: [
        ...
        { id: 'thf_t30b', name: 'Godstrike', type: 'active', desc: '6.8x true damage. Guaranteed critical (4x). Only usable once per battle. Miss = instant death.', manaCost: 45, multiplier: 6.8, effect: 'godstrike', icon: 'A', milestone: true },
      ...
      { level: 62, label: 'Tier 31', choices: [
        ...
        { id: 'thf_t31b', name: 'Death Blossom', type: 'active', desc: '2.9x true damage 3 times, each apply 2 turn poison', manaCost: 34, multiplier: 2.9, effect: 'death_blossom', icon: 'A' },
      ...
      { level: 64, label: 'Tier 32', choices: [
        ...
        { id: 'thf_t32b', name: 'Twilight Strike', type: 'active', desc: '5x true damage, dodge next 4 attacks', manaCost: 36, multiplier: 5, effect: 'twilight_strike', icon: 'A' },
      ...
      { level: 66, label: 'Tier 33', choices: [
        ...
        { id: 'thf_t33b', name: 'Shadow Maelstrom', type: 'active', desc: '3.3x true damage 3 times, each hit ignores all DEF', manaCost: 38, multiplier: 3.3, effect: 'shadow_maelstrom', icon: 'A' },
      ...
      { level: 68, label: 'Tier 34', choices: [
        ...
        { id: 'thf_t34b', name: 'Void Assassination', type: 'active', desc: '5.5x true damage, if kills refund all mana + dodge 3 attacks', manaCost: 38, multiplier: 5.5, effect: 'void_assassination', icon: 'A' },
      ...
      { level: 70, label: '★ Tier 35', milestone: true, choices: [
        ...
        { id: 'thf_t35b', name: 'Perfect Kill', type: 'active', desc: '8.8x true damage. Guaranteed critical (5x). Costs 50% current HP. If enemy survives, gain +50% dodge for rest of fight.', manaCost: 55, multiplier: 8.8, effect: 'perfect_kill', icon: 'A', milestone: true },
      ...
      { level: 72, label: 'Tier 36', choices: [
        ...
        { id: 'thf_t36b', name: 'Phantasmal Barrage', type: 'active', desc: '3.9x true damage 3 times, dodge next 3 attacks', manaCost: 40, multiplier: 3.9, effect: 'phantasmal_barrage', icon: 'A' },
      ...
      { level: 74, label: 'Tier 37', choices: [
        ...
        { id: 'thf_t37b', name: 'Eclipse Strike', type: 'active', desc: '6.6x true damage, enemy ATK & DEF -40%', manaCost: 42, multiplier: 6.6, effect: 'eclipse_strike', icon: 'A' },
      ...
      { level: 76, label: 'Tier 38', choices: [
        ...
        { id: 'thf_t38b', name: 'Shadow Obliteration', type: 'active', desc: '4.4x true damage 2 times, each hit guaranteed critical', manaCost: 42, multiplier: 4.4, effect: 'shadow_obliteration', icon: 'A' },
      ...
      { level: 78, label: 'Tier 39', choices: [
        ...
        { id: 'thf_t39b', name: 'Annihilation Dance', type: 'active', desc: '3.9x true damage 3 times, dodge all attacks for 2 turns', manaCost: 44, multiplier: 3.9, effect: 'annihilation_dance', icon: 'A' },
      ...
      { level: 80, label: '★ Tier 40', milestone: true, choices: [
        ...
        { id: 'thf_t40b', name: 'Final Assassination', type: 'active', desc: '6.8x true damage. Guaranteed critical (6x). Costs all mana and 50% HP. If enemy dies, fully restore everything.', manaCost: 60, multiplier: 6.8, effect: 'final_assassination', icon: 'A', milestone: true },
      ...
      { level: 82, label: 'Tier 41', choices: [
        ...
        { id: 'thf_t41b', name: 'Phantom Annihilator', type: 'active', desc: '5.5x true damage 2 times, guaranteed crits, dodge 4 attacks', manaCost: 44, multiplier: 5.5, effect: 'phantom_annihilator', icon: 'A' },
      ...
      { level: 84, label: 'Tier 42', choices: [
        ...
        { id: 'thf_t42b', name: 'Shadow Cataclysm', type: 'active', desc: '4.4x true damage 3 times, each apply lethal poison', manaCost: 46, multiplier: 4.4, effect: 'shadow_cataclysm', icon: 'A' },
      ...
      { level: 86, label: 'Tier 43', choices: [
        ...
        { id: 'thf_t43b', name: 'Doom Blade', type: 'active', desc: '6.3x true damage, apply doom for 5 turns, dodge next 3 attacks', manaCost: 44, multiplier: 6.3, effect: 'doom_blade', icon: 'A' },
      ...
      { level: 88, label: 'Tier 44', choices: [
        ...
        { id: 'thf_t44b', name: 'Eternal Night', type: 'active', desc: '5.5x true damage 2 times, guaranteed crits, enemy ATK & DEF -50%', manaCost: 46, multiplier: 5.5, effect: 'eternal_night', icon: 'A' },
      ...
      { level: 90, label: '★ Tier 45', milestone: true, choices: [
        ...
        { id: 'thf_t45b', name: 'Absolute Kill', type: 'active', desc: '9.1x true damage. Guaranteed critical (7x). Costs 80% current HP. If enemy survives at <5% HP, instant kill. The perfect strike.', manaCost: 70, multiplier: 9.1, effect: 'absolute_kill', icon: 'A', milestone: true },
      ...
      { level: 92, label: 'Tier 46', choices: [
        ...
        { id: 'thf_t46b', name: 'Shadow Apocalypse', type: 'active', desc: '5.5x true damage 3 times, guaranteed crits', manaCost: 48, multiplier: 5.5, effect: 'shadow_apocalypse', icon: 'A' },
      ...
      { level: 94, label: 'Tier 47', choices: [
        ...
        { id: 'thf_t47b', name: 'Void Strike', type: 'active', desc: '7.2x true damage, guaranteed critical, dodge 5 attacks', manaCost: 50, multiplier: 7.2, effect: 'void_strike', icon: 'A' },
      ...
      { level: 96, label: 'Tier 48', choices: [
        ...
        { id: 'thf_t48b', name: 'Oblivion Assassination', type: 'active', desc: '6.6x true damage 2 times, guaranteed crits (6x), dodge all for 2 turns', manaCost: 50, multiplier: 6.6, effect: 'oblivion_assassination', icon: 'A' },
      ...
      { level: 98, label: 'Tier 49', choices: [
        ...
        { id: 'thf_t49b', name: 'End of Shadow', type: 'active', desc: '9x true damage, guaranteed critical (7x), dodge all attacks for 3 turns', manaCost: 52, multiplier: 9, effect: 'end_shadow', icon: 'A' },
      ...
      { level: 100, label: '★ Tier 50', milestone: true, choices: [
        ...
        { id: 'thf_t50b', name: 'Final Shadow', type: 'active', desc: '10x true damage. Guaranteed critical (8x). Costs all HP except 1 and all mana. If enemy dies, fully restore. The ultimate assassination.', manaCost: 1, multiplier: 10, effect: 'final_shadow', icon: 'A', milestone: true },
  ...
  mage: {
    tiers: [
      { level: 2, label: 'Tier 1', choices: [
        ...
        { id: 'mag_t1b', name: 'Fireball', type: 'active', desc: '1.5x true damage (ignores DEF)', manaCost: 10, multiplier: 1.5, effect: 'true_damage', icon: 'A' },
      ...
      { level: 4, label: 'Tier 2', choices: [
        ...
        { id: 'mag_t2b', name: 'Ice Lance', type: 'active', desc: '1.2x damage, reduce enemy ATK by 20%', manaCost: 10, multiplier: 1.2, effect: 'freeze', icon: 'A' },
      ...
      { level: 6, label: 'Tier 3', choices: [
        ...
        { id: 'mag_t3b', name: 'Meteor', type: 'active', desc: '2.3x true damage (ignores DEF)', manaCost: 20, multiplier: 2.3, effect: 'true_damage', icon: 'A' },
      ...
      { level: 8, label: 'Tier 4', choices: [
        ...
        { id: 'mag_t4b', name: 'Chain Lightning', type: 'active', desc: '1.9x damage, reduce enemy DEF by 25%', manaCost: 16, multiplier: 1.9, effect: 'chain_lightning', icon: 'A' },
      ...
      { level: 10, label: 'Tier 5', choices: [
        ...
        { id: 'mag_t5b', name: 'Frost Nova', type: 'active', desc: '1.4x damage, enemy ATK -30%', manaCost: 14, multiplier: 1.4, effect: 'frost_nova', icon: 'A' },
      ...
      { level: 12, label: 'Tier 6', choices: [
        ...
        { id: 'mag_t6b', name: 'Lightning Bolt', type: 'active', desc: '1.7x true damage', manaCost: 14, multiplier: 1.7, effect: 'true_damage', icon: 'A' },
      ...
      { level: 14, label: 'Tier 7', choices: [
        ...
        { id: 'mag_t7b', name: 'Blizzard', type: 'active', desc: '1.5x damage, enemy ATK & DEF -15%', manaCost: 16, multiplier: 1.5, effect: 'blizzard', icon: 'A' },
      ...
      { level: 16, label: 'Tier 8', choices: [
        ...
        { id: 'mag_t8b', name: 'Pyroblast', type: 'active', desc: '2.3x true damage', manaCost: 22, multiplier: 2.3, effect: 'true_damage', icon: 'A' },
      ...
      { level: 18, label: 'Tier 9', choices: [
        ...
        { id: 'mag_t9b', name: 'Arcane Torrent', type: 'active', desc: '2.3x damage, restore 50% mana spent', manaCost: 20, multiplier: 2.3, effect: 'mana_refund', icon: 'A' },
      ...
      { level: 20, label: 'Tier 10', choices: [
        ...
        { id: 'mag_t10b', name: 'Cataclysm', type: 'active', desc: '3.3x true damage', manaCost: 30, multiplier: 3.3, effect: 'true_damage', icon: 'A' },
      ...
      { level: 22, label: 'Tier 11', choices: [
        ...
        { id: 'mag_t11b', name: 'Inferno', type: 'active', desc: '2.3x true damage, enemy ATK -20%', manaCost: 18, multiplier: 2.3, effect: 'inferno', icon: 'A' },
      ...
      { level: 24, label: 'Tier 12', choices: [
        ...
        { id: 'mag_t12b', name: 'Arcane Missiles', type: 'active', desc: '1.5x true damage 3 times', manaCost: 20, multiplier: 1.5, effect: 'arcane_missiles', icon: 'A' },
      ...
      { level: 26, label: 'Tier 13', choices: [
        ...
        { id: 'mag_t13b', name: 'Comet', type: 'active', desc: '2.9x true damage, reduce enemy DEF by 40%', manaCost: 24, multiplier: 2.9, effect: 'comet', icon: 'A' },
      ...
      { level: 28, label: 'Tier 14', choices: [
        ...
        { id: 'mag_t14b', name: 'Void Bolt', type: 'active', desc: '2.6x true damage, drain 10% enemy max HP as mana', manaCost: 22, multiplier: 2.6, effect: 'void_bolt', icon: 'A' },
      ...
      { level: 30, label: '★ Tier 15', milestone: true, choices: [
        ...
        { id: 'mag_t15b', name: 'Supernova', type: 'active', desc: '5x true damage. Drains ALL remaining mana. Deals bonus damage equal to mana spent.', manaCost: 1, multiplier: 5, effect: 'supernova', icon: 'A', milestone: true },
      ...
      { level: 32, label: 'Tier 16', choices: [
        ...
        { id: 'mag_t16b', name: 'Disintegrate', type: 'active', desc: '3.6x true damage, ignore all DEF', manaCost: 26, multiplier: 3.6, effect: 'true_damage', icon: 'A' },
      ...
      { level: 34, label: 'Tier 17', choices: [
        ...
        { id: 'mag_t17b', name: 'Apocalyptic Fire', type: 'active', desc: '3.3x true damage, enemy burns for 4% max HP/turn for 3 turns', manaCost: 24, multiplier: 3.3, effect: 'apoc_fire', icon: 'A' },
      ...
      { level: 36, label: 'Tier 18', choices: [
        ...
        { id: 'mag_t18b', name: 'Gravity Well', type: 'active', desc: '2.6x true damage, stun enemy 1 turn, ATK & DEF -20%', manaCost: 24, multiplier: 2.6, effect: 'gravity_well', icon: 'A' },
      ...
      { level: 38, label: 'Tier 19', choices: [
        ...
        { id: 'mag_t19b', name: 'Starfall', type: 'active', desc: '2.6x true damage 2 times', manaCost: 30, multiplier: 2.6, effect: 'double_true', icon: 'A' },
      ...
      { level: 40, label: '★ Tier 20', milestone: true, choices: [
        ...
        { id: 'mag_t20b', name: 'Singularity', type: 'active', desc: '6.3x true damage. After casting, you cannot cast spells for 2 turns (cooldown).', manaCost: 45, multiplier: 6.3, effect: 'singularity', icon: 'A', milestone: true },
      ...
      { level: 42, label: 'Tier 21', choices: [
        ...
        { id: 'mag_t21b', name: 'Chain Destruction', type: 'active', desc: '2.9x true damage, reduce enemy DEF by 50%', manaCost: 26, multiplier: 2.9, effect: 'chain_destruction', icon: 'A' },
      ...
      { level: 44, label: 'Tier 22', choices: [
        ...
        { id: 'mag_t22b', name: 'Dimensional Rift', type: 'active', desc: '3.9x true damage, dodge next attack', manaCost: 28, multiplier: 3.9, effect: 'dim_rift', icon: 'A' },
      ...
      { level: 46, label: 'Tier 23', choices: [
        ...
        { id: 'mag_t23b', name: 'Cosmic Ray', type: 'active', desc: '3.9x true damage', manaCost: 32, multiplier: 3.9, effect: 'true_damage', icon: 'A' },
      ...
      { level: 48, label: 'Tier 24', choices: [
        ...
        { id: 'mag_t24b', name: 'Oblivion Beam', type: 'active', desc: '4.4x true damage, costs 20% current HP too', manaCost: 34, multiplier: 4.4, effect: 'oblivion_beam', icon: 'A' },
      ...
      { level: 50, label: '★ Tier 25', milestone: true, choices: [
        ...
        { id: 'mag_t25b', name: 'Big Bang', type: 'active', desc: '6.8x true damage. Costs ALL mana and 50% HP. 1 use per battle. The ultimate gambit.', manaCost: 1, multiplier: 6.8, effect: 'big_bang', icon: 'A', milestone: true },
      ...
      { level: 52, label: 'Tier 26', choices: [
        ...
        { id: 'mag_t26b', name: 'Plasma Bolt', type: 'active', desc: '3.9x true damage, reduce enemy DEF by 50%', manaCost: 28, multiplier: 3.9, effect: 'plasma_bolt', icon: 'A' },
      ...
      { level: 54, label: 'Tier 27', choices: [
        ...
        { id: 'mag_t27b', name: 'Cosmic Blast', type: 'active', desc: '3.9x true damage, enemy ATK & DEF -30%', manaCost: 30, multiplier: 3.9, effect: 'cosmic_blast', icon: 'A' },
      ...
      { level: 56, label: 'Tier 28', choices: [
        ...
        { id: 'mag_t28b', name: 'Void Storm', type: 'active', desc: '3.3x true damage 2 times, drain 15% enemy max HP as mana', manaCost: 32, multiplier: 3.3, effect: 'void_storm', icon: 'A' },
      ...
      { level: 58, label: 'Tier 29', choices: [
        ...
        { id: 'mag_t29b', name: 'Annihilation Beam', type: 'active', desc: '4.4x true damage, ignore all DEF', manaCost: 34, multiplier: 4.4, effect: 'annihilation_beam', icon: 'A' },
      ...
      { level: 60, label: '★ Tier 30', milestone: true, choices: [
        ...
        { id: 'mag_t30b', name: 'Genesis', type: 'active', desc: '6.8x true damage. Restores all mana after cast. Can only be used once per battle. Drains 30% max HP.', manaCost: 45, multiplier: 6.8, effect: 'genesis', icon: 'A', milestone: true },
      ...
      { level: 62, label: 'Tier 31', choices: [
        ...
        { id: 'mag_t31b', name: 'Arcane Devastation', type: 'active', desc: '3.9x true damage 2 times, restore 40% mana spent', manaCost: 32, multiplier: 3.9, effect: 'arcane_devastation', icon: 'A' },
      ...
      { level: 64, label: 'Tier 32', choices: [
        ...
        { id: 'mag_t32b', name: 'Dimensional Collapse', type: 'active', desc: '5x true damage, stun 2 turns, enemy ATK & DEF -40%', manaCost: 36, multiplier: 5, effect: 'dim_collapse', icon: 'A' },
      ...
      { level: 66, label: 'Tier 33', choices: [
        ...
        { id: 'mag_t33b', name: 'Starburst', type: 'active', desc: '3.3x true damage 3 times', manaCost: 36, multiplier: 3.3, effect: 'starburst', icon: 'A' },
      ...
      { level: 68, label: 'Tier 34', choices: [
        ...
        { id: 'mag_t34b', name: 'Celestial Ray', type: 'active', desc: '5.5x true damage, heal 20% max HP', manaCost: 38, multiplier: 5.5, effect: 'celestial_ray', icon: 'A' },
      ...
      { level: 70, label: '★ Tier 35', milestone: true, choices: [
        ...
        { id: 'mag_t35b', name: 'Cosmic Annihilation', type: 'active', desc: '8.8x true damage. Drains ALL mana. Bonus damage equal to 200% of mana spent. The power of a dying star.', manaCost: 1, multiplier: 8.8, effect: 'cosmic_annihilation', icon: 'A', milestone: true },
      ...
      { level: 72, label: 'Tier 36', choices: [
        ...
        { id: 'mag_t36b', name: 'Arcane Tempest', type: 'active', desc: '3.9x true damage 2 times, restore 50% mana spent', manaCost: 38, multiplier: 3.9, effect: 'arcane_tempest', icon: 'A' },
      ...
      { level: 74, label: 'Tier 37', choices: [
        ...
        { id: 'mag_t37b', name: 'Galactic Storm', type: 'active', desc: '3.9x true damage 3 times, enemy ATK & DEF -40%', manaCost: 42, multiplier: 3.9, effect: 'galactic_storm', icon: 'A' },
      ...
      { level: 76, label: 'Tier 38', choices: [
        ...
        { id: 'mag_t38b', name: 'Reality Tear', type: 'active', desc: '6.6x true damage, stun 1 turn, enemy ATK & DEF -50%', manaCost: 42, multiplier: 6.6, effect: 'reality_tear', icon: 'A' },
      ...
      { level: 78, label: 'Tier 39', choices: [
        ...
        { id: 'mag_t39b', name: 'Celestial Cataclysm', type: 'active', desc: '5.5x true damage 2 times, heal 25% of total damage dealt', manaCost: 44, multiplier: 5.5, effect: 'celestial_cata', icon: 'A' },
      ...
      { level: 80, label: '★ Tier 40', milestone: true, choices: [
        ...
        { id: 'mag_t40b', name: 'Universe End', type: 'active', desc: '6.8x true damage. Costs ALL mana and 60% HP. Bonus damage equal to 300% mana spent. 1 use per battle. The death of stars.', manaCost: 1, multiplier: 6.8, effect: 'universe_end', icon: 'A', milestone: true },
      ...
      { level: 82, label: 'Tier 41', choices: [
        ...
        { id: 'mag_t41b', name: 'Star Destroyer', type: 'active', desc: '5.5x true damage 2 times, restore all mana spent', manaCost: 40, multiplier: 5.5, effect: 'star_destroyer', icon: 'A' },
      ...
      { level: 84, label: 'Tier 42', choices: [
        ...
        { id: 'mag_t42b', name: 'Dimensional Annihilation', type: 'active', desc: '6.3x true damage, ignore all DEF, enemy ATK -50%', manaCost: 44, multiplier: 6.3, effect: 'dim_annihilation', icon: 'A' },
      ...
      { level: 86, label: 'Tier 43', choices: [
        ...
        { id: 'mag_t43b', name: 'Void Annihilation', type: 'active', desc: '4.4x true damage 3 times, drain 20% enemy max HP as mana each hit', manaCost: 46, multiplier: 4.4, effect: 'void_annihilation', icon: 'A' },
      ...
      { level: 88, label: 'Tier 44', choices: [
        ...
        { id: 'mag_t44b', name: 'Creation Blast', type: 'active', desc: '6.6x true damage 2 times, heal 30% of total damage dealt', manaCost: 48, multiplier: 6.6, effect: 'creation_blast', icon: 'A' },
      ...
      { level: 90, label: '★ Tier 45', milestone: true, choices: [
        ...
        { id: 'mag_t45b', name: 'Cosmic Genesis', type: 'active', desc: '9.1x true damage. Costs ALL mana and 70% HP. Bonus damage equal to 500% mana spent. If enemy survives, fully restore mana.', manaCost: 1, multiplier: 9.1, effect: 'cosmic_genesis', icon: 'A', milestone: true },
      ...
      { level: 92, label: 'Tier 46', choices: [
        ...
        { id: 'mag_t46b', name: 'Eternity Blast', type: 'active', desc: '6.3x true damage 2 times, restore all mana', manaCost: 48, multiplier: 6.3, effect: 'eternity_blast', icon: 'A' },
      ...
      { level: 94, label: 'Tier 47', choices: [
        ...
        { id: 'mag_t47b', name: 'Dimensional Rift+', type: 'active', desc: '7.2x true damage, stun 2 turns, immune to damage for 1 turn', manaCost: 50, multiplier: 7.2, effect: 'dim_rift_plus', icon: 'A' },
      ...
      { level: 96, label: 'Tier 48', choices: [
        ...
        { id: 'mag_t48b', name: 'Oblivion Storm', type: 'active', desc: '5.5x true damage 3 times, each hit reduces enemy ATK & DEF by 20%', manaCost: 52, multiplier: 5.5, effect: 'oblivion_storm', icon: 'A' },
      ...
      { level: 98, label: 'Tier 49', choices: [
        ...
        { id: 'mag_t49b', name: 'End of Reality', type: 'active', desc: '9x true damage 2 times, ignore all DEF, heal 30% of total damage', manaCost: 54, multiplier: 9, effect: 'end_reality', icon: 'A' },
      ...
      { level: 100, label: '★ Tier 50', milestone: true, choices: [
        ...
        { id: 'mag_t50b', name: 'Final Big Bang', type: 'active', desc: '10x true damage. Costs ALL mana, ALL HP except 1. Bonus damage equal to 1000% mana spent. If enemy dies, fully restore. The universe reborn.', manaCost: 1, multiplier: 10, effect: 'final_big_bang', icon: 'A', milestone: true },
  ...
  necromancer: {
    tiers: [
      { level: 2, label: 'Tier 1', choices: [
        ...
        { id: 'nec_t1b', name: 'Bone Spear', type: 'active', desc: '1.4x damage, ignores 40% DEF', manaCost: 8, multiplier: 1.4, effect: 'pierce_40', icon: 'A' },
      ...
      { level: 4, label: 'Tier 2', choices: [
        ...
        { id: 'nec_t2b', name: 'Plague', type: 'active', desc: '1x damage, strong poison for 4 turns', manaCost: 10, multiplier: 1, effect: 'strong_poison', icon: 'A' },
      ...
      { level: 6, label: 'Tier 3', choices: [
        ...
        { id: 'nec_t3b', name: 'Soul Harvest', type: 'active', desc: '1.9x damage, heal 60% of damage dealt', manaCost: 15, multiplier: 1.9, effect: 'soul_harvest', icon: 'A' },
      ...
      { level: 8, label: 'Tier 4', choices: [
        ...
        { id: 'nec_t4b', name: 'Doom', type: 'active', desc: '1.5x damage, enemy takes 8% max HP/turn for 3 turns', manaCost: 20, multiplier: 1.5, effect: 'doom', icon: 'A' },
      ...
      { level: 10, label: 'Tier 5', choices: [
        ...
        { id: 'nec_t5b', name: 'Corpse Explosion', type: 'active', desc: '1.7x damage, +50% if enemy is poisoned', manaCost: 12, multiplier: 1.7, effect: 'corpse_explode', icon: 'A' },
      ...
      { level: 12, label: 'Tier 6', choices: [
        ...
        { id: 'nec_t6b', name: 'Shadow Bolt', type: 'active', desc: '1.8x damage, ignores 30% DEF', manaCost: 12, multiplier: 1.8, effect: 'pierce_30', icon: 'A' },
      ...
      { level: 14, label: 'Tier 7', choices: [
        ...
        { id: 'nec_t7b', name: 'Death Coil', type: 'active', desc: '1.5x damage, heal 100% of damage dealt', manaCost: 18, multiplier: 1.5, effect: 'full_drain', icon: 'A' },
      ...
      { level: 16, label: 'Tier 8', choices: [
        ...
        { id: 'nec_t8b', name: 'Wither', type: 'active', desc: '1.3x damage, reduce enemy ATK and DEF by 25%', manaCost: 16, multiplier: 1.3, effect: 'wither', icon: 'A' },
      ...
      { level: 18, label: 'Tier 9', choices: [
        ...
        { id: 'nec_t9b', name: 'Army of the Dead', type: 'active', desc: '2.3x damage, heal 40% of damage dealt', manaCost: 22, multiplier: 2.3, effect: 'army_drain', icon: 'A' },
      ...
      { level: 20, label: 'Tier 10', choices: [
        ...
        { id: 'nec_t10b', name: 'Apocalypse', type: 'active', desc: '2.9x damage, doom for 4 turns, heal 30%', manaCost: 30, multiplier: 2.9, effect: 'nec_apocalypse', icon: 'A' },
      ...
      { level: 22, label: 'Tier 11', choices: [
        ...
        { id: 'nec_t11b', name: 'Spirit Lance', type: 'active', desc: '2.3x damage, heal 50% of damage dealt', manaCost: 18, multiplier: 2.3, effect: 'spirit_lance', icon: 'A' },
      ...
      { level: 24, label: 'Tier 12', choices: [
        ...
        { id: 'nec_t12b', name: 'Bone Storm', type: 'active', desc: '1.9x damage 2 times, ignore 30% DEF each hit', manaCost: 20, multiplier: 1.9, effect: 'bone_storm', icon: 'A' },
      ...
      { level: 26, label: 'Tier 13', choices: [
        ...
        { id: 'nec_t13b', name: 'Devouring Plague', type: 'active', desc: '2.3x damage, doom 4 turns, heal 20% of damage', manaCost: 22, multiplier: 2.3, effect: 'devouring_plague', icon: 'A' },
      ...
      { level: 28, label: 'Tier 14', choices: [
        ...
        { id: 'nec_t14b', name: 'Soul Rend', type: 'active', desc: '2.9x damage, steal 10% enemy ATK permanently', manaCost: 24, multiplier: 2.9, effect: 'soul_rend', icon: 'A' },
      ...
      { level: 30, label: '★ Tier 15', milestone: true, choices: [
        ...
        { id: 'nec_t15b', name: 'Soul Apocalypse', type: 'active', desc: '4.4x damage. Costs 25% HP. Heals 100% of damage dealt. Dooms enemy for 5 turns. If enemy survives, your max HP is reduced by 10% for the fight.', manaCost: 35, multiplier: 4.4, effect: 'soul_apocalypse', icon: 'A', milestone: true },
      ...
      { level: 32, label: 'Tier 16', choices: [
        ...
        { id: 'nec_t16b', name: 'Necrotic Burst', type: 'active', desc: '2.6x damage, +100% if enemy is doomed or poisoned', manaCost: 22, multiplier: 2.6, effect: 'necrotic_burst', icon: 'A' },
      ...
      { level: 34, label: 'Tier 17', choices: [
        ...
        { id: 'nec_t17b', name: 'Abyssal Strike', type: 'active', desc: '3.3x damage, ignore 50% DEF, heal 30% of damage', manaCost: 26, multiplier: 3.3, effect: 'abyssal_strike', icon: 'A' },
      ...
      { level: 36, label: 'Tier 18', choices: [
        ...
        { id: 'nec_t18b', name: 'Mass Wither', type: 'active', desc: '2.3x damage, reduce enemy ATK and DEF by 40%', manaCost: 24, multiplier: 2.3, effect: 'mass_wither', icon: 'A' },
      ...
      { level: 38, label: 'Tier 19', choices: [
        ...
        { id: 'nec_t19b', name: 'Death Wave', type: 'active', desc: '3.6x damage, doom 3 turns, poison 3 turns', manaCost: 28, multiplier: 3.6, effect: 'death_wave', icon: 'A' },
      ...
      { level: 40, label: '★ Tier 20', milestone: true, choices: [
        ...
        { id: 'nec_t20b', name: 'Extinction Event', type: 'active', desc: '6.6x damage. Heals 50% of damage dealt. Dooms for 5 turns. Costs 30% current HP. Your max HP is permanently reduced by 5% each use (stacks).', manaCost: 40, multiplier: 6.6, effect: 'extinction_event', icon: 'A', milestone: true },
      ...
      { level: 42, label: 'Tier 21', choices: [
        ...
        { id: 'nec_t21b', name: 'Siphon Soul', type: 'active', desc: '2.6x damage, steal 15% enemy max HP as healing', manaCost: 24, multiplier: 2.6, effect: 'siphon_soul', icon: 'A' },
      ...
      { level: 44, label: 'Tier 22', choices: [
        ...
        { id: 'nec_t22b', name: 'Banshee Wail', type: 'active', desc: '2.3x damage, stun 1 turn, enemy ATK -30%', manaCost: 24, multiplier: 2.3, effect: 'banshee_wail', icon: 'A' },
      ...
      { level: 46, label: 'Tier 23', choices: [
        ...
        { id: 'nec_t23b', name: 'Death Grip', type: 'active', desc: '3.9x damage, heal 40% of damage, enemy DEF -50%', manaCost: 30, multiplier: 3.9, effect: 'death_grip', icon: 'A' },
      ...
      { level: 48, label: 'Tier 24', choices: [
        ...
        { id: 'nec_t24b', name: 'Annihilation', type: 'active', desc: '3.9x damage, doom 4 turns, heal 50% of damage dealt', manaCost: 34, multiplier: 3.9, effect: 'annihilation', icon: 'A' },
      ...
      { level: 50, label: '★ Tier 25', milestone: true, choices: [
        ...
        { id: 'nec_t25b', name: 'Requiem', type: 'active', desc: '9x damage. Costs 50% current HP. Heals 100% of damage. Dooms for 6 turns. If enemy survives with <10% HP, instant kill. The final song.', manaCost: 50, multiplier: 9, effect: 'requiem', icon: 'A', milestone: true },
      ...
      { level: 52, label: 'Tier 26', choices: [
        ...
        { id: 'nec_t26b', name: 'Soul Devastation', type: 'active', desc: '3.9x damage, heal 80% of damage dealt, doom 3 turns', manaCost: 28, multiplier: 3.9, effect: 'soul_devastation', icon: 'A' },
      ...
      { level: 54, label: 'Tier 27', choices: [
        ...
        { id: 'nec_t27b', name: 'Abyssal Nova', type: 'active', desc: '3.9x damage, doom 4 turns, poison 4 turns, heal 30%', manaCost: 30, multiplier: 3.9, effect: 'abyssal_nova', icon: 'A' },
      ...
      { level: 56, label: 'Tier 28', choices: [
        ...
        { id: 'nec_t28b', name: 'Deathstorm', type: 'active', desc: '3.3x damage 2 times, each apply doom 3 turns and poison 3 turns', manaCost: 32, multiplier: 3.3, effect: 'deathstorm', icon: 'A' },
      ...
      { level: 58, label: 'Tier 29', choices: [
        ...
        { id: 'nec_t29b', name: 'Soul Annihilation', type: 'active', desc: '4.4x damage, steal 20% enemy ATK permanently, heal 50%', manaCost: 34, multiplier: 4.4, effect: 'soul_annihilation', icon: 'A' },
      ...
      { level: 60, label: '★ Tier 30', milestone: true, choices: [
        ...
        { id: 'nec_t30b', name: 'Soul Apocalypse+', type: 'active', desc: '6.8x damage. Costs 30% HP. Heals 150% of damage dealt. Dooms for 6 turns. Poisons for 6 turns. The ultimate drain.', manaCost: 45, multiplier: 6.8, effect: 'soul_apocalypse_plus', icon: 'A', milestone: true },
      ...
      { level: 62, label: 'Tier 31', choices: [
        ...
        { id: 'nec_t31b', name: 'Plague Storm', type: 'active', desc: '2.9x damage 3 times, each apply doom 2 turns and poison 2 turns', manaCost: 34, multiplier: 2.9, effect: 'plague_storm', icon: 'A' },
      ...
      { level: 64, label: 'Tier 32', choices: [
        ...
        { id: 'nec_t32b', name: 'Death Ray', type: 'active', desc: '5x damage, ignore 60% DEF, heal 60% of damage dealt', manaCost: 36, multiplier: 5, effect: 'death_ray', icon: 'A' },
      ...
      { level: 66, label: 'Tier 33', choices: [
        ...
        { id: 'nec_t33b', name: 'Vile Eruption', type: 'active', desc: '4.1x damage, +100% if enemy has 3+ DoT effects', manaCost: 34, multiplier: 4.1, effect: 'vile_eruption', icon: 'A' },
      ...
      { level: 68, label: 'Tier 34', choices: [
        ...
        { id: 'nec_t34b', name: 'Soul Cataclysm', type: 'active', desc: '5.5x damage, doom 5 turns, heal 70% of damage dealt', manaCost: 38, multiplier: 5.5, effect: 'soul_cataclysm', icon: 'A' },
      ...
      { level: 70, label: '★ Tier 35', milestone: true, choices: [
        ...
        { id: 'nec_t35b', name: 'Requiem Eternal', type: 'active', desc: '8.8x damage. Costs 60% HP. Heals 200% of damage. Doom 8 turns. Poison 8 turns. If enemy below 15% after, instant kill.', manaCost: 55, multiplier: 8.8, effect: 'requiem_eternal', icon: 'A', milestone: true },
      ...
      { level: 72, label: 'Tier 36', choices: [
        ...
        { id: 'nec_t36b', name: 'Death Cascade', type: 'active', desc: '3.9x damage 3 times, heal 40% of total damage', manaCost: 38, multiplier: 3.9, effect: 'death_cascade', icon: 'A' },
      ...
      { level: 74, label: 'Tier 37', choices: [
        ...
        { id: 'nec_t37b', name: 'Doomsday Plague', type: 'active', desc: '4.4x damage, doom 6 turns, poison 6 turns, bleed 6 turns, heal 40%', manaCost: 40, multiplier: 4.4, effect: 'doomsday_plague', icon: 'A' },
      ...
      { level: 76, label: 'Tier 38', choices: [
        ...
        { id: 'nec_t38b', name: 'Annihilation Wave', type: 'active', desc: '6.6x damage, doom 5 turns, heal 80% of damage dealt', manaCost: 42, multiplier: 6.6, effect: 'annihilation_wave', icon: 'A' },
      ...
      { level: 78, label: 'Tier 39', choices: [
        ...
        { id: 'nec_t39b', name: 'Soul Oblivion', type: 'active', desc: '5.5x damage 2 times, heal 60% of total damage, doom 4 turns each', manaCost: 44, multiplier: 5.5, effect: 'soul_oblivion', icon: 'A' },
      ...
      { level: 80, label: '★ Tier 40', milestone: true, choices: [
        ...
        { id: 'nec_t40b', name: 'Extinction Requiem', type: 'active', desc: '6.8x damage. Costs 70% HP. Heals 300% of damage dealt. Doom and poison for 10 turns. If enemy survives at <20%, instant kill.', manaCost: 60, multiplier: 6.8, effect: 'extinction_requiem', icon: 'A', milestone: true },
      ...
      { level: 82, label: 'Tier 41', choices: [
        ...
        { id: 'nec_t41b', name: 'Soul Maelstrom', type: 'active', desc: '4.4x damage 3 times, heal 50% of total damage, each apply doom', manaCost: 42, multiplier: 4.4, effect: 'soul_maelstrom', icon: 'A' },
      ...
      { level: 84, label: 'Tier 42', choices: [
        ...
        { id: 'nec_t42b', name: 'Cataclysmic Doom', type: 'active', desc: '6.3x damage, doom 8 turns, poison 8 turns, heal 100% of damage', manaCost: 46, multiplier: 6.3, effect: 'cataclysmic_doom', icon: 'A' },
      ...
      { level: 86, label: 'Tier 43', choices: [
        ...
        { id: 'nec_t43b', name: 'Plague Apocalypse', type: 'active', desc: '4.4x damage 3 times, each apply eternal doom and eternal poison', manaCost: 46, multiplier: 4.4, effect: 'plague_apocalypse', icon: 'A' },
      ...
      { level: 88, label: 'Tier 44', choices: [
        ...
        { id: 'nec_t44b', name: 'Soul Devastation+', type: 'active', desc: '6.6x damage 2 times, heal 80% of total damage, doom 6 turns each', manaCost: 48, multiplier: 6.6, effect: 'soul_devastation_plus', icon: 'A' },
      ...
      { level: 90, label: '★ Tier 45', milestone: true, choices: [
        ...
        { id: 'nec_t45b', name: 'Final Requiem', type: 'active', desc: '9.1x damage. Costs 80% HP. Heals 500% of damage dealt. Doom and poison forever. If enemy below 25% after, instant kill. The song that ends worlds.', manaCost: 70, multiplier: 9.1, effect: 'final_requiem', icon: 'A', milestone: true },
      ...
      { level: 92, label: 'Tier 46', choices: [
        ...
        { id: 'nec_t46b', name: 'Oblivion Plague', type: 'active', desc: '5.5x damage 3 times, each apply eternal doom and poison, heal 50% total', manaCost: 50, multiplier: 5.5, effect: 'oblivion_plague', icon: 'A' },
      ...
      { level: 94, label: 'Tier 47', choices: [
        ...
        { id: 'nec_t47b', name: 'Death Incarnation', type: 'active', desc: '7.2x damage, doom forever, heal 100% of damage, steal 20% enemy ATK', manaCost: 52, multiplier: 7.2, effect: 'death_incarnation', icon: 'A' },
      ...
      { level: 96, label: 'Tier 48', choices: [
        ...
        { id: 'nec_t48b', name: 'Apocalypse Eternal', type: 'active', desc: '6.6x damage 3 times, heal 70% total, doom and poison forever each hit', manaCost: 54, multiplier: 6.6, effect: 'apocalypse_eternal', icon: 'A' },
      ...
      { level: 98, label: 'Tier 49', choices: [
        ...
        { id: 'nec_t49b', name: 'End of Death', type: 'active', desc: '9x damage, heal 200% of damage dealt, doom and poison forever, steal 30% enemy ATK', manaCost: 56, multiplier: 9, effect: 'end_of_death', icon: 'A' },
      ...
      { level: 100, label: '★ Tier 50', milestone: true, choices: [
        ...
        { id: 'nec_t50b', name: 'Final Requiem Absolute', type: 'active', desc: '10x damage. Costs all HP except 1. Heals 1000% of damage dealt. Doom and poison forever. If enemy survives, you gain +200% ATK. The ultimate death song.', manaCost: 1, multiplier: 10, effect: 'final_requiem_absolute', icon: 'A', milestone: true },
