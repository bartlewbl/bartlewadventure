...
const DEFAULTS = {
  ...
  'passive.lifetapHeal': 0.02,
  'passive.vampiricAura': 0.015,
  'passive.soulSiphonChance': 0.05,
  'passive.bloodlustHeal': 0.03,
  'passive.regeneration': 0.005,
  'passive.endurance': 0.008,
  'passive.indestructible': 0.01,
  'passive.soulFortressHeal': 0.008,
  'passive.darkPactDrain': 0.01,
  'passive.darkPactUpgradedDrain': 0.005,
  'passive.pactOfUndeath': 0.002,
  'passive.manaRegen': 0.01,
  'passive.leylineTap': 0.02,
  'passive.shadowStep': 0.02,
  'passive.evasionMastery': 0.015,
  'passive.cloakOfShadows': 0.03,
  'passive.phantomExistence': 0.06,
  'passive.livingShadow': 0.10,
  'passive.dodgeCap': 0.20,
  'passive.aegisChance': 0.02,
  'passive.aegisUpgraded': 0.04,
  'passive.smokeBomb': 0.04,
  'passive.cursedBlood': 0.03,
  'passive.bladeDance': 0.02,
  'passive.swiftStrikes': 0.03,
  'passive.luckyStrike': 0.04,
  'passive.opportunityStrikes': 0.06,
  'passive.spellEcho': 0.04,
  'passive.spellEchoUpgraded': 0.06,
  'passive.defendBlock': 0.5,
  'passive.fortifyBlock': 0.45,
  'passive.bulwarkBlock': 0.35,
  'passive.phalanxBlock': 0.25,
  'passive.ironSkin': 0.97,
  'passive.thickSkin': 0.98,
  'passive.fortress': 0.95,
  'passive.soulFortressDR': 0.97,
  'passive.eternalGuardian': 0.88,
  'passive.battleHardenedRate': 0.003,
  'passive.battleHardenedCap': 0.08,
