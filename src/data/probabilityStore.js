...
const DEFAULTS = {
  ...
  'combat.monsterCritMultiplier': 1.5,
  ...
  'passive.lifetapHeal': 0.15,
  'passive.vampiricAura': 0.10,
  'passive.soulSiphonChance': 0.25,
  'passive.bloodlustHeal': 0.20,
  'passive.regeneration': 0.03,
  'passive.endurance': 0.05,
  'passive.indestructible': 0.08,
  'passive.soulFortressHeal': 0.05,
  'passive.darkPactDrain': 0.05,
  'passive.darkPactUpgradedDrain': 0.03,
  'passive.pactOfUndeath': 0.01,
  'passive.manaRegen': 0.08,
  'passive.leylineTap': 0.12,
  'passive.shadowStep': 0.15,
  'passive.evasionMastery': 0.10,
  'passive.cloakOfShadows': 0.20,
  'passive.phantomExistence': 0.50,
  'passive.livingShadow': 0.75,
  'passive.dodgeCap': 0.90,
  'passive.aegisChance': 0.15,
  'passive.aegisUpgraded': 0.25,
  'passive.smokeBomb': 0.25,
  'passive.cursedBlood': 0.20,
  'passive.bladeDance': 0.10,
  'passive.swiftStrikes': 0.20,
  'passive.luckyStrike': 0.20,
  'passive.opportunityStrikes': 0.35,
  'passive.spellEcho': 0.20,
  'passive.spellEchoUpgraded': 0.35,
  'passive.defendBlock': 0.5,
  'passive.fortifyBlock': 0.3,
  'passive.bulwarkBlock': 0.15,
  'passive.phalanxBlock': 0.05,
  'passive.ironSkin': 0.9,
  'passive.thickSkin': 0.92,
  'passive.fortress': 0.8,
  'passive.soulFortressDR': 0.85,
  'passive.eternalGuardian': 0.5,
  'passive.battleHardenedRate': 0.02,
  'passive.battleHardenedCap': 0.40,
