...
export default function SidePanel({
  ...
  const navItems = [
    ...
    },
    {
      id: 'bounty',
      label: 'Bounties',
      description: 'Hunt for gold rewards',
      onClick: onBounty,
      active: screen === 'bounty',
      disabled: navLocked,
    },
    {
      id: 'mercenary',
      label: 'Mercenaries',
      description: 'Hire combat help',
      onClick: onMercenary,
      active: screen === 'mercenary',
      disabled: navLocked,
    },
    {
      id: 'enchant',
    ...
    },
    {
      ...
      onClick: onRespec,
      active: screen === 'respec',
      disabled: navLocked,
    },
    {
      id: 'cosmetic',
      label: 'Cosmetics',
      description: 'Personalize your hero',
      onClick: onCosmetic,
      active: screen === 'cosmetic',
      disabled: navLocked,
    },
  ];
